...
namespace RefinementFuzzing
{
	...
	public class ConcurrentContext
	{
        ...
        */
		...
		public ConcurrentContext(StratifiedVCGen vcgen, VerificationState vstate, SoftPartition spartition, int threadBudget, WaitHandle waitHandles, ProverInterface prover)
		{
			id = getNewThreadId();
	...
	public class RF
	{
		...
		public static void SelectCandidates(StratifiedVCGen.FCallHandler calls, ProverInterface prover, List<int> candidates)
		{
			//return;
		...
		public static void SelectCandidates4(StratifiedVCGen.FCallHandler calls, ProverInterface prover, List<int> candidates)
		{
		...
		{
			private StratifiedVCGen.FCallHandler calls;
			...
			public MyErrHandler(StratifiedVCGen.FCallHandler calls, List<int> candidates)
			{
		...
		public static void SelectCandidates3(StratifiedVCGen.FCallHandler calls, ProverInterface prover, List<int> candidates)
		{
