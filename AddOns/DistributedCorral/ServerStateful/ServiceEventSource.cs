...
{
    [EventSource(Name = "MyCompany-DistributedCorral-ServerStateful")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        public void MessageInformational(string message)
        {
        ...
        [Event(11, Level = EventLevel.Verbose, Message = "Constructed instance of type {0}")]
        public void ServiceInstanceConstructed(string serviceType)
        {
            this.WriteEvent(11, serviceType);
        }

        [Event(12, Level = EventLevel.Error, Message = "Exception {0}")]
        public void GotException(string e)
        {
            this.WriteEvent(12, e);
        }

        [Event(13, Level = EventLevel.Verbose, Message = "{0} | Solving {1} | Input remaining: {2}")]
        public void SolvingInput(Guid partitionId, string inputFile, long remainingTest)
        {
            this.WriteEvent(13, partitionId, inputFile, remainingTest);
        }


        [Event(14, Level = EventLevel.LogAlways, Message = "{0}")]
        public void MessageMustLog(string msg)
        {
            this.WriteEvent(14, msg);
        }

        [Event(15, Level = EventLevel.Warning, Message = "{0}")]
        public void MessageWarning(string msg)
        {
            this.WriteEvent(15, msg);
        }
        ...
        [Event(MessageEventId, Level = EventLevel.Verbose, Message = "{0}")]
        ...
        [Event(ServiceTypeRegisteredEventId, Level = EventLevel.Verbose, Message = "Service host process {0} registered service type {1}", Keywords = Keywords.ServiceInitialization)]
        ...
        [Event(ServiceRequestStartEventId, Level = EventLevel.Verbose, Message = "Service request '{0}' started", Keywords = Keywords.Requests)]
        ...
        [Event(ServiceRequestStopEventId, Level = EventLevel.Verbose, Message = "Service request '{0}' finished", Keywords = Keywords.Requests)]
