...
// via /home/shaobo/project/smack/install/bin/smack extern_mem_fail.c -bpl extern_mem_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 140));
...
axiom (__SMACK_decls == $sub.ref(0, 84));
...
axiom (__SMACK_top_decl == $sub.ref(0, 92));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 100));
...
const foo: ref;
axiom (foo == $sub.ref(0, 116));
procedure  foo($p0: ref);
const bar: ref;
axiom (bar == $sub.ref(0, 124));
procedure {:AngelicUnknown} bar()
  returns ($r: ref);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 132));
procedure  llvm.dbg.value($p0: ref, $i1: i64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 140));
