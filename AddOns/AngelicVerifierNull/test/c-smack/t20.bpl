...
// via /usr/local/bin/smack --no-verify t20.c -bpl t20.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 345));
...
$bb0:
  ...
  assume {:sourceloc "t20.c", 5, 19} true;
  call $p0 := malloc(4);
  assume {:sourceloc "t20.c", 5, 12} true;
  $p1 := $bitcast.ref.ref($p0);
  call {:cexpr "y"} boogie_si_record_ref($p1);
  assume {:sourceloc "t20.c", 6, 3} true;
  $i2 := $ne.ref(x, $p1);
  assume {:sourceloc "t20.c", 6, 3} true;
  $i3 := $zext.i1.i32($i2);
  assume {:sourceloc "t20.c", 6, 3} true;
  call __VERIFIER_assert($i3);
  assume {:sourceloc "t20.c", 7, 1} true;
  $exn := false;
  return;
}
const malloc: ref;
axiom (malloc == $sub.ref(0, 329));
