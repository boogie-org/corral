...
// via /usr/local/bin/smack --no-verify t10.c -bpl t10.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 351));
...
axiom (llvm.dbg.declare == $sub.ref(0, 279));
