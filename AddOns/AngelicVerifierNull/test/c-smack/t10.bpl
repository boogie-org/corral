...
// via /usr/local/bin/smack t10.c -bpl t10.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point main
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 124));
...
axiom (llvm.dbg.declare == $sub.ref(0, 52));
