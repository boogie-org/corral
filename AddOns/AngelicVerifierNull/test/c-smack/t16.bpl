...
// via /usr/local/bin/smack --no-verify t16.c -bpl t16.bpl
...
const ends_in_dotpc: ref;
axiom (ends_in_dotpc == $sub.ref(0, 329));
procedure  ends_in_dotpc( str: ref)
  returns ({:scalar} $r: i32)
{
  ...
  var {:scalar} $i9: i32;
  var {:scalar} $i10: i64;
  var {:base "str"} $p11: ref;
  var {:scalar} $i12: i8;
  var {:scalar} $i13: i32;
  var {:scalar} $i14: i1;
  var {:scalar} $i15: i32;
  var {:scalar} $i16: i64;
  var {:base "str"} $p17: ref;
  var {:scalar} $i18: i8;
  var {:scalar} $i19: i32;
  var {:scalar} $i20: i1;
  var {:scalar} $i21: i32;
$bb0:
  call {:cexpr "str"} boogie_si_record_ref(str);
  assume {:sourceloc "t16.c", 8, 13} true;
  call $i0 := strlen(str);
  assume {:sourceloc "t16.c", 8, 13} true;
  $i1 := $trunc.i64.i32($i0);
  call {:cexpr "len"} boogie_si_record_i32($i1);
  assume {:sourceloc "t16.c", 10, 7} true;
  $i2 := $sgt.i32($i1, 3);
  assume {:sourceloc "t16.c", 10, 7} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "t16.c", 11, 11} true;
  $i3 := $sub.i32($i1, 3);
  assume {:sourceloc "t16.c", 11, 7} true;
  $i4 := $sext.i32.i64($i3);
  assume {:sourceloc "t16.c", 11, 7} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "t16.c", 16, 5} true;
  $i21 := 0;
  goto $bb10;
$bb4:
  assume ($i8 == 1);
  assume {:sourceloc "t16.c", 12, 11} true;
  $i9 := $sub.i32($i1, 2);
  assume {:sourceloc "t16.c", 12, 7} true;
  $i10 := $sext.i32.i64($i9);
  assume {:sourceloc "t16.c", 12, 7} true;
  $p11 := $add.ref(str, $mul.ref($i10, 1));
  assume {:sourceloc "t16.c", 12, 7} true;
  $i12 := $load.i8($M.0, $p11);
  assume {:sourceloc "t16.c", 12, 7} true;
  $i13 := $sext.i8.i32($i12);
...
$bb6:
  assume ($i14 == 1);
  assume {:sourceloc "t16.c", 13, 11} true;
  $i15 := $sub.i32($i1, 1);
  assume {:sourceloc "t16.c", 13, 7} true;
...
$bb8:
  assume ($i20 == 1);
  assume {:sourceloc "t16.c", 14, 5} true;
  $i21 := 1;
  goto $bb10;
$bb9:
  assume {:sourceloc "t16.c", 10, 7} true;
  ...
  goto $bb3;
$bb10:
  assume {:sourceloc "t16.c", 17, 1} true;
  $r := $i21;
  $exn := false;
  return;
}
const strlen: ref;
axiom (strlen == $sub.ref(0, 337));
procedure  strlen( $p0: ref)
  returns ({:scalar} $r: i64);
