...
procedure foo({:pointer} x: int) returns ($r: int);
...
implementation foo(x: int) returns ($r: int)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "forloop.c", 6, 12} true;
    $p0 := x;
    assume {:sourceloc "forloop.c", 6, 12} true;
    assert !aliasQ0(x, NULL);
    $p1 := $M.0[$p0];
    call {:cexpr "y"} boogie_si_record_ref($p1);
    assume {:sourceloc "forloop.c", 6, 8} true;
    $p2 := $p1;
    goto $bb1;

  $bb1:
    assume {:sourceloc "forloop.c", 6, 18} true;
  ...
  $bb2:
    assume {:partition} !($p2 == NULL);
    assume {:sourceloc "forloop.c", 6, 23} true;
    $p4 := $p2 + 8;
    assume {:sourceloc "forloop.c", 6, 23} true;
    ...
    assume {:sourceloc "forloop.c", 6, 3} true;
  ...
  $bb4:
    assume {:sourceloc "forloop.c", 7, 3} true;
    $r := $p2;
    $exn := false;
    return;
  ...
  $bb5:
    ...
    assume {:sourceloc "forloop.c", 6, 33} true;
    $p7 := $p2;
    assume {:sourceloc "forloop.c", 6, 33} true;
    assert !aliasQ2($p2, NULL);
    $p8 := $M.1[$p7];
    call {:cexpr "y"} boogie_si_record_ref($p8);
    assume {:sourceloc "forloop.c", 6, 3} true;
    $p2 := $p8;
    goto $bb1;
...
const {:allocated} bar: int;

axiom bar == NULL - 337;

procedure bar({:pointer} k: int);



implementation bar(k: int)
{
  var $p0: int;
  var {:base "$p0"} $p1: int;
  ...
  $bb0:
    ...
    assume {:sourceloc "forloop.c", 12, 3} true;
    call $p0 := foo(k);
    assume {:sourceloc "forloop.c", 12, 3} true;
    $p1 := $p0 + 8;
    assume {:sourceloc "forloop.c", 12, 3} true;
    ...
    $M.1 := $M.1[$p1 := 1];
    assume {:sourceloc "forloop.c", 13, 1} true;
    $exn := false;
    return;
}
