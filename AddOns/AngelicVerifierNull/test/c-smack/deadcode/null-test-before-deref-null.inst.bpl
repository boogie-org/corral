...
procedure foo({:pointer} x: int) returns ({:scalar} $r: int);
...
implementation foo(x: int) returns ($r: int)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "null-test-before-deref.c", 5, 11} true;
    $p0 := x;
    assume {:sourceloc "null-test-before-deref.c", 5, 11} true;
    ...
    assume {:sourceloc "null-test-before-deref.c", 6, 7} true;
    $i3 := (if x != NULL then 1 else NULL);
    assume {:sourceloc "null-test-before-deref.c", 6, 7} true;
    assume {:branchcond $i3} true;
    goto $bb1, $bb2;

  $bb1:
    assume {:partition} !(x == NULL);
    assume {:sourceloc "null-test-before-deref.c", 9, 5} true;
    $i4 := $i2;
    goto $bb3;

  $bb2:
    assume {:partition} x == NULL;
    assume {:sourceloc "null-test-before-deref.c", 7, 5} true;
    $i4 := NULL - 1;
    goto $bb3;

  $bb3:
    assume {:sourceloc "null-test-before-deref.c", 10, 1} true;
    $r := $i4;
    $exn := false;
    return;
}
...
axiom __SMACK_static_init == NULL - 345;
