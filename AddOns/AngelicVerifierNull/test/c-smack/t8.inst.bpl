...
axiom __SMACK_code == NULL - 88;

procedure __SMACK_code.ref($p0: int);



const __VERIFIER_nondet_int: int;

axiom __VERIFIER_nondet_int == NULL - 96;

procedure {:inline 1} __VERIFIER_nondet_int() returns ({:scalar} $r: int);



const __SMACK_decls: int;

axiom __SMACK_decls == NULL - 104;
...
axiom __SMACK_top_decl == NULL - 112;
...
axiom __SMACK_init_func_memory_model == NULL - 120;
...
implementation P()
{
  ...
  $bb0:
    assume {:sourceloc "t8.c", 10, 6} true;
    $i0 := $M.0;
    assume {:sourceloc "t8.c", 10, 6} true;
  ...
  $bb1:
    assume $i1 == 1;
    assume {:sourceloc "t8.c", 12, 16} true;
    call $p2 := malloc(8);
    assume {:sourceloc "t8.c", 12, 10} true;
    $p3 := $p2;
    assume {:sourceloc "t8.c", 12, 6} true;
    assert !aliasQ0(x, NULL);
    $p4 := $M.2[x];
    assume {:sourceloc "t8.c", 12, 5} true;
    assert !aliasQ1($p4, NULL);
    $M.3 := $M.3[$p4 := $p3];
    assume {:sourceloc "t8.c", 13, 3} true;
    goto $bb3;
  ...
  $bb3:
    assume {:sourceloc "t8.c", 14, 1} true;
    $exn := false;
    return;
}
...
implementation Q()
{
  ...
  $bb0:
    assume {:sourceloc "t8.c", 17, 6} true;
    $i0 := $M.0;
    assume {:sourceloc "t8.c", 17, 6} true;
    $i1 := (if $i0 == 1 then 1 else NULL);
    assume {:sourceloc "t8.c", 17, 6} true;
    assume {:branchcond $i1} true;
    goto $bb1, $bb2;
  ...
  $bb1:
    assume $i1 == 1;
    assume {:sourceloc "t8.c", 19, 13} true;
    assert !aliasQ2(x, NULL);
    $p2 := $M.2[x];
    assume {:sourceloc "t8.c", 19, 12} true;
    assert !aliasQ3($p2, NULL);
    $p3 := $M.3[$p2];
    assume {:sourceloc "t8.c", 19, 11} true;
    assert !aliasQ4($p3, NULL);
    $i4 := $M.1[$p3];
    assume {:sourceloc "t8.c", 19, 11} true;
    $i5 := $i4 + 1;
    assume {:sourceloc "t8.c", 19, 7} true;
    assert !aliasQ5(x, NULL);
    $p6 := $M.2[x];
    assume {:sourceloc "t8.c", 19, 6} true;
    assert !aliasQ6($p6, NULL);
    $p7 := $M.3[$p6];
    assume {:sourceloc "t8.c", 19, 5} true;
    assert !aliasQ7($p7, NULL);
    $M.1 := $M.1[$p7 := $i5];
    assume {:sourceloc "t8.c", 20, 3} true;
    goto $bb3;
  ...
  $bb3:
    assume {:sourceloc "t8.c", 21, 1} true;
    $exn := false;
    return;
}
...
implementation foo(f: int)
{
  ...
  $bb0:
    ...
    call devirtbounce(f);
    assume {:sourceloc "t8.c", 25, 1} true;
    $exn := false;
    return;
}
...
procedure {:entrypoint} bar() returns ({:scalar} $r: int);



implementation {:entrypoint} bar() returns ($r: int)
{
  var $p0: int;
  var $p1: int;
  var {:scalar} $i2: int;
  ...
  $bb0:
    call $initialize();
    assume {:sourceloc "t8.c", 28, 7} true;
    call $p0 := malloc(4);
    assume {:sourceloc "t8.c", 28, 7} true;
    $p1 := $p0;
    assume {:sourceloc "t8.c", 28, 3} true;
    assert !aliasQ8(x, NULL);
    $M.2 := $M.2[x := $p1];
    call {:cexpr "x"} boogie_si_record_ref($p1);
    assume {:sourceloc "t8.c", 29, 7} true;
    call $i2 := __VERIFIER_nondet_int();
    assume {:sourceloc "t8.c", 29, 3} true;
    $M.0 := $i2;
    call {:cexpr "y"} boogie_si_record_i32($i2);
    assume {:sourceloc "t8.c", 30, 3} true;
    call foo(P);
    assume {:sourceloc "t8.c", 31, 3} true;
    call foo(Q);
    assume {:sourceloc "t8.c", 32, 3} true;
    $r := NULL;
    $exn := false;
    return;
}
...
axiom __SMACK_static_init == NULL - 176;
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    $M.0 := NULL;
    call {:cexpr "y"} boogie_si_record_i32(NULL);
    assert !aliasQ9(x, NULL);
    $M.2 := $M.2[x := NULL];
...
axiom devirtbounce == NULL - 184;

procedure devirtbounce(funcPtr: int);



implementation devirtbounce(funcPtr: int)
{
  var $p0: int;
  var {:scalar} $i1: int;
  var {:scalar} $i2: int;
