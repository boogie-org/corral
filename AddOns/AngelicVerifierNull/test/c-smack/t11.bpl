...
// via /usr/local/bin/smack --no-verify t11.c -bpl t11.bpl
...
axiom (__VERIFIER_assert == $sub.ref(0, 303));
...
{
$bb0:
  $M.0 := $store.ref($M.0, head, $0.ref);
  call {:cexpr "head"} boogie_si_record_ref($0.ref);
  $exn := false;
  return;
}
