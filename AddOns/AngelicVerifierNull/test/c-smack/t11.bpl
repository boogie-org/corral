...
// via /usr/local/bin/smack t11.c -bpl t11.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point main
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 132));
...
axiom (__VERIFIER_assert == $sub.ref(0, 76));
