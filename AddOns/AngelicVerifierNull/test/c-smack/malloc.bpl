...
// via /home/shaobo/project/smack/install/bin/smack malloc.c -bpl malloc.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 224));
...
$bb0:
  call $initialize();
  assume {:sourceloc "malloc.c", 5, 19} true;
  call $p0 := malloc(4);
  assume {:sourceloc "malloc.c", 5, 12} true;
  $p1 := $bitcast.ref.ref($p0);
  call {:cexpr "x"} boogie_si_record_ref($p1);
  assume {:sourceloc "malloc.c", 6, 19} true;
  call $p2 := malloc(4);
  assume {:sourceloc "malloc.c", 6, 12} true;
  $p3 := $bitcast.ref.ref($p2);
  call {:cexpr "y"} boogie_si_record_ref($p3);
  assume {:sourceloc "malloc.c", 7, 3} true;
  $M.2 := $store.i32($M.2, $p1, 1);
  assume {:sourceloc "malloc.c", 8, 3} true;
  $M.3 := $store.i32($M.3, $p3, 2);
  assume {:sourceloc "malloc.c", 9, 3} true;
  $i4 := $ne.ref($p1, $p3);
  assume {:sourceloc "malloc.c", 9, 3} true;
  $i5 := $zext.i1.i32($i4);
  assume {:sourceloc "malloc.c", 9, 3} true;
  call __VERIFIER_assert($i5);
  assume {:sourceloc "malloc.c", 10, 1} true;
  $r := 0;
  $exn := false;
  return;
}
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 216));
procedure  llvm.dbg.value($p0: ref, $i1: i64, $p2: ref, $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 224));
