...
// via /usr/local/bin/smack --no-verify extern_mem_fail.c -bpl extern_mem_fail.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 367));
...
axiom (__SMACK_dummy == $sub.ref(0, 279));
...
axiom (__SMACK_code == $sub.ref(0, 287));
procedure  __SMACK_code.ref( $p0: ref);
procedure  __SMACK_code.ref.i32( $p0: ref,  p.1: i32);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 295));
...
axiom (__SMACK_decls == $sub.ref(0, 303));
...
axiom (__SMACK_top_decl == $sub.ref(0, 311));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 319));
