...
// RUN: %avn "%t1.bpl" /nodup /traceSlicing /copt:recursionBound:5 /copt:k:1 /dontGeneralize /copt:tryCTrace /EE:ignoreAllAssumes+ /EE:onlySlicAssumes- /EE:ignoreAllAssumes- | %grep > %t3
// RUN: %diff "%s.expect" %t3

// generated by SMACK version 1.5.2 for corral
// via /usr/local/bin/smack --no-verify t22.c -bpl t22.bpl
...
$bb0:
  ...
  assume {:sourceloc "t22.c", 7, 7} true;
  $i0 := $ne.ref(x, $0.ref);
  assume {:sourceloc "t22.c", 7, 7} true;
  assume {:branchcond $i0} true;
  goto $bb1, $bb2;
$bb1:
  assume {:partition} !((x == $0.ref));
  assume {:sourceloc "t22.c", 10, 15} true;
  call $p2 := malloc(4);
  assume {:sourceloc "t22.c", 10, 9} true;
...
$bb2:
  assume {:partition} (x == $0.ref);
  call {:cexpr "y"} boogie_si_record_ref($0.ref);
  assume {:sourceloc "t22.c", 8, 5} true;
  $p1 := $0.ref;
  goto $bb3;
$bb3:
  assume {:sourceloc "t22.c", 11, 3} true;
  $M.0 := $store.i32($M.0, $p1, 1);
  assume {:sourceloc "t22.c", 12, 1} true;
  $exn := false;
  return;
}
