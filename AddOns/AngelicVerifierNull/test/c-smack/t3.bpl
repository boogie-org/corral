...
$bb0:
  ...
  assume {:sourceloc "t3.c", 11, 6} true;
  $p0 := $eq.i32(b, 0);
  assume {:sourceloc "t3.c", 11, 6} true;
  goto $bb1, $bb2;
$bb1:
  assume ($p0 == 1);
  assume {:sourceloc "t3.c", 12, 3} true;
  $p1 := $ne.i64(a, 0);
  assume {:sourceloc "t3.c", 12, 3} true;
  $p2 := $zext.i1.i32($p1);
  assume {:sourceloc "t3.c", 12, 3} true;
  ...
  assume {:sourceloc "t3.c", 12, 3} true;
  assert $p4 != $0.i32;
  assume {:sourceloc "t3.c", 13, 3} true;
  $p5 := 0;
  goto $bb3;
$bb2:
  assume !(($p0 == 1));
  assume {:sourceloc "t3.c", 15, 18} true;
  call $p6 := $malloc(16);
  assume {:sourceloc "t3.c", 15, 18} true;
  $p7 := $p6;
  call {:cexpr "s"} boogie_si_record_ref($p7);
  assume {:sourceloc "t3.c", 16, 2} true;
  $p8 := $add.ref($add.ref($p7, $zext.i32.ref($mul.i32(0, 16))), $zext.i32.ref($mul.i32(0, 1)));
  assume {:sourceloc "t3.c", 16, 2} true;
  $M.1[$p8] := b;
  assume {:sourceloc "t3.c", 17, 2} true;
  $p9 := $add.ref($add.ref($p7, $zext.i32.ref($mul.i32(0, 16))), $zext.i32.ref($mul.i32(8, 1)));
  assume {:sourceloc "t3.c", 17, 2} true;
  $M.1[$p9] := a;
  assume {:sourceloc "t3.c", 18, 2} true;
  $p5 := $p7;
  goto $bb3;
$bb3:
  assume {:sourceloc "t3.c", 19, 1} true;
  $r := $p5;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "t3.c", 22, 2} true;
  $p0 := $ne.i64(w, 0);
  assume {:sourceloc "t3.c", 22, 2} true;
  $p1 := $zext.i1.i32($p0);
  assume {:sourceloc "t3.c", 22, 2} true;
  ...
  assume {:sourceloc "t3.c", 22, 2} true;
  assert $p3 != $0.i32;
  assume {:sourceloc "t3.c", 23, 19} true;
  $p4 := $M.2[w];
  assume {:sourceloc "t3.c", 23, 19} true;
  call $p5 := foo($p4, w);
  call {:cexpr "s"} boogie_si_record_ref($p5);
  assume {:sourceloc "t3.c", 24, 2} true;
  $p6 := $ne.i64($p5, 0);
  assume {:sourceloc "t3.c", 24, 2} true;
  $p7 := $zext.i1.i32($p6);
  assume {:sourceloc "t3.c", 24, 2} true;
  ...
  assume {:sourceloc "t3.c", 24, 2} true;
  assert $p9 != $0.i32;
  assume {:sourceloc "t3.c", 25, 2} true;
  ...
  assume {:sourceloc "t3.c", 25, 2} true;
  assert $p17 != $0.i32;
  assume {:sourceloc "t3.c", 26, 1} true;
  $exn := false;
  return;
}
axiom (foo == -8);
...
axiom (__SMACK_decls == -56);
axiom (__SMACK_top_decl == -64);
axiom (llvm.dbg.value == -72);
axiom $0.i1 == 0;
axiom $0.i32 == 0;
axiom $1.i1 == 1;
axiom $and.i1(0,0) == 0;
