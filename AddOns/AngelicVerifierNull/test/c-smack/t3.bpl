...
// via /usr/local/bin/smack t3.c -bpl t3.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point func
...
const func: ref;
axiom (func == $sub.ref(0, 124));
procedure {:entrypoint} func( w: ref)
{
  var {:scalar} $i0: i32;
  var $p1: ref;
  var $p2: ref;
