...
// via /usr/local/bin/smack test_list.c -bpl test_list.bpl --no-verify --verifier-options=/doModSetAnalysis
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 635));
...
const .str1266: ref;
axiom (.str1266 == $sub.ref(0, 306));
const .str11267: ref;
axiom (.str11267 == $sub.ref(0, 312));
const .str21268: ref;
axiom (.str21268 == $sub.ref(0, 314));
const .str31269: ref;
axiom (.str31269 == $sub.ref(0, 357));
const .str41270: ref;
axiom (.str41270 == $sub.ref(0, 374));
const .str51271: ref;
axiom (.str51271 == $sub.ref(0, 423));
const .str61272: ref;
axiom (.str61272 == $sub.ref(0, 469));
const .str71273: ref;
axiom (.str71273 == $sub.ref(0, 499));
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 507));
procedure  llvm.dbg.declare({:scalar} $p0: ref, {:scalar} $p1: ref, {:scalar} $p2: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 515));
...
axiom (__SMACK_code == $sub.ref(0, 523));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 531));
...
axiom (__SMACK_top_decl == $sub.ref(0, 539));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 547));
...
const main: ref;
axiom (main == $sub.ref(0, 555));
procedure {:entrypoint} main({:scalar} argc: i32,  argv: ref)
  returns ({:scalar} $r: i32)
{
  ...
  var $p10: ref;
  var {:scalar} $i11: i32;
  var {:base "$p10"} $p12: ref;
  var {:base "$p10"} $p13: ref;
  var {:scalar} $i14: i32;
  var {:base "$p10"} $p15: ref;
  var {:base "$p0"} $p16: ref;
  var {:scalar} $i17: i32;
  var {:scalar} $i18: i32;
  var {:scalar} $i19: i32;
  ...
  var {:scalar} $i25: i1;
  var $p26: ref;
  var {:base "$p26"} $p27: ref;
  var $p28: ref;
  var {:base "$p28"} $p29: ref;
  var {:scalar} $i30: i32;
  var {:base "$p28"} $p31: ref;
  var {:scalar} $i32: i32;
  var {:scalar} $i33: i32;
  var {:base "$p23"} $p34: ref;
  var $p35: ref;
  var {:scalar} $i36: i32;
  var {:scalar} $i37: i32;
  var {:base "$p0"} $p38: ref;
  ...
  var $p40: ref;
  var $p41: ref;
  var {:base "$p41"} $p42: ref;
  var $p43: ref;
  var $p44: ref;
  var {:base "$p44"} $p45: ref;
  var {:base "$p0"} $p46: ref;
  var {:scalar} $i47: i1;
  var {:base "$p44"} $p48: ref;
  var {:scalar} $i49: i32;
  var {:base "$p44"} $p50: ref;
  var {:scalar} $i51: i32;
  var {:scalar} $i52: i32;
  var {:base "$p44"} $p53: ref;
  var {:base "$p44"} $p54: ref;
  var $p55: ref;
  var $p56: ref;
  var {:base "$p56"} $p57: ref;
  var $p58: ref;
  var {:scalar} $i59: i32;
  var {:scalar} $i60: i32;
  var {:base "$p0"} $p61: ref;
  ...
  var {:scalar} $i69: i1;
  var $p70: ref;
  var {:base "$p70"} $p71: ref;
  var $p72: ref;
  var {:base "$p72"} $p73: ref;
  var {:scalar} $i74: i32;
  var {:base "$p72"} $p75: ref;
  var {:scalar} $i76: i32;
  var {:scalar} $i77: i32;
  var $p78: ref;
  var {:base "$p67"} $p79: ref;
  var $p80: ref;
$bb0:
  call $initialize();
...
$bb3:
  ...
  call $i18 := printf.ref(.str21268);
  assume {:sourceloc "test_list.c", 58, 2} true;
  call $i19 := printf.ref(.str31269);
...
$bb5:
  ...
  assume {:sourceloc "test_list.c", 67, 9} true;
  $p27 := $add.ref($p26, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($0.ref, 8))), 1));
  assume {:sourceloc "test_list.c", 67, 9} true;
  ...
  call $i33 := printf.ref.i32.i32(.str41270, $i30, $i32);
  assume {:sourceloc "test_list.c", 59, 2} true;
  $p34 := $p23;
  assume {:sourceloc "test_list.c", 59, 2} true;
...
$bb6:
  ...
  call $i36 := printf.ref(.str21268);
  assume {:sourceloc "test_list.c", 87, 2} true;
  call $i37 := printf.ref(.str51271);
  ...
  assume {:sourceloc "test_list.c", 88, 2} true;
  $p42 := $add.ref($p41, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($0.ref, 8))), 1));
  assume {:sourceloc "test_list.c", 88, 2} true;
...
$bb8:
  ...
  call $i52 := printf.ref.i32.i32(.str41270, $i49, $i51);
  assume {:sourceloc "test_list.c", 88, 2} true;
  $p53 := $add.ref($p44, 8);
  $p54 := $add.ref($p44, 8);
  assume {:sourceloc "test_list.c", 88, 2} true;
  ...
  assume {:sourceloc "test_list.c", 88, 2} true;
  $p57 := $add.ref($p56, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($0.ref, 8))), 1));
  assume {:sourceloc "test_list.c", 88, 2} true;
...
$bb9:
  ...
  call $i59 := printf.ref(.str21268);
  assume {:sourceloc "test_list.c", 98, 2} true;
  call $i60 := printf.ref(.str61272);
...
$bb11:
  ...
  assume {:sourceloc "test_list.c", 100, 9} true;
  $p71 := $add.ref($p70, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($0.ref, 8))), 1));
  assume {:sourceloc "test_list.c", 100, 9} true;
...
const printf: ref;
axiom (printf == $sub.ref(0, 571));
procedure  printf.ref.i32.i32( $p0: ref,  p.1: i32,  p.2: i32)
  returns ({:scalar} $r: i32);
procedure  printf.ref( $p0: ref)
  returns ({:scalar} $r: i32);
const __isoc99_scanf: ref;
axiom (__isoc99_scanf == $sub.ref(0, 579));
procedure  __isoc99_scanf.ref.ref.ref( $p0: ref, {:scalar} p.1: ref, {:scalar} p.2: ref)
  returns ({:scalar} $r: i32);
const free_: ref;
axiom (free_ == $sub.ref(0, 587));
procedure  free_( $p0: ref)
{
  call $free($p0);
}
const list_add: ref;
axiom (list_add == $sub.ref(0, 595));
...
axiom (__list_del == $sub.ref(0, 611));
...
axiom (__list_add == $sub.ref(0, 619));
