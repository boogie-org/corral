...
// via /usr/local/bin/smack link-list-test.c -bpl link-list-test.bpl --no-verify --verifier-options=/doModSetAnalysis
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 538));
...
const .str3: ref;
axiom (.str3 == $sub.ref(0, 60));
const .str1262: ref;
axiom (.str1262 == $sub.ref(0, 121));
const .str1263: ref;
axiom (.str1263 == $sub.ref(0, 184));
const .str1264: ref;
axiom (.str1264 == $sub.ref(0, 287));
const .str1266: ref;
axiom (.str1266 == $sub.ref(0, 308));
const .str11267: ref;
axiom (.str11267 == $sub.ref(0, 325));
const {:count 39} __PRETTY_FUNCTION__.add_node: ref;
axiom (__PRETTY_FUNCTION__.add_node == $sub.ref(0, 364));
const .str21268: ref;
axiom (.str21268 == $sub.ref(0, 368));
const .str31269: ref;
axiom (.str31269 == $sub.ref(0, 370));
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 378));
procedure  llvm.dbg.declare({:scalar} $p0: ref, {:scalar} $p1: ref, {:scalar} $p2: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 386));
...
axiom (__SMACK_code == $sub.ref(0, 394));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 402));
...
axiom (__SMACK_top_decl == $sub.ref(0, 410));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 418));
...
const add_node: ref;
axiom (add_node == $sub.ref(0, 426));
procedure  add_node({:scalar} arg: i32,  head: ref)
{
  var $p0: ref;
  var $p1: ref;
  var {:scalar} $i2: i1;
...
$bb2:
  assume !(($i2 == 1));
  assume {:sourceloc "link-list-test.c", 14, 5} true;
  call __assert_fail(.str1266, .str11267, 14, __PRETTY_FUNCTION__.add_node);
  assume {:sourceloc "link-list-test.c", 14, 5} true;
  assume false;
}
const malloc: ref;
axiom (malloc == $sub.ref(0, 434));
...
axiom (__assert_fail == $sub.ref(0, 442));
procedure  __assert_fail( $p0: ref,  $p1: ref, {:scalar} $i2: i32,  $p3: ref);
const display: ref;
axiom (display == $sub.ref(0, 450));
procedure  display( head: ref)
{
  var {:base "head"} $p0: ref;
  var $p1: ref;
  var $p2: ref;
  var {:scalar} $i3: i1;
  var $p4: ref;
...
$bb2:
  ...
  assume {:sourceloc "link-list-test.c", 27, 18} true;
  $p5 := $add.ref($p4, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($0.ref, 8))), 1));
  assume {:sourceloc "link-list-test.c", 27, 18} true;
  ...
  call $i9 := printf.ref.i32(.str21268, $i8);
  assume {:sourceloc "link-list-test.c", 26, 5} true;
  $p10 := $p2;
  assume {:sourceloc "link-list-test.c", 26, 5} true;
...
$bb3:
  ...
  call $i12 := printf.ref(.str31269);
  assume {:sourceloc "link-list-test.c", 31, 1} true;
  $exn := false;
  return;
}
const printf: ref;
axiom (printf == $sub.ref(0, 458));
procedure  printf.ref( $p0: ref)
  returns ({:scalar} $r: i32);
procedure  printf.ref.i32( $p0: ref,  p.1: i32)
  returns ({:scalar} $r: i32);
const delete_all: ref;
axiom (delete_all == $sub.ref(0, 466));
procedure  delete_all( head: ref)
{
  var {:base "head"} $p0: ref;
  var $p1: ref;
  var {:scalar} $i2: i1;
...
$bb2:
  ...
  assume {:sourceloc "link-list-test.c", 40, 18} true;
  $p4 := $add.ref($p3, $mul.ref($sub.i64(0, $p2i.ref.i64($add.ref($0.ref, 8))), 1));
  assume {:sourceloc "link-list-test.c", 40, 18} true;
...
const free_: ref;
axiom (free_ == $sub.ref(0, 474));
procedure  free_( $p0: ref)
{
  call $free($p0);
}
const find_first_and_delete: ref;
axiom (find_first_and_delete == $sub.ref(0, 482));
procedure  find_first_and_delete({:scalar} arg: i32,  head: ref)
  returns ({:scalar} $r: i32)
{
  var {:base "head"} $p0: ref;
  var $p1: ref;
...
const list_add: ref;
axiom (list_add == $sub.ref(0, 498));
procedure  list_add( new: ref,  head: ref)
{
  var {:base "head"} $p0: ref;
  var $p1: ref;
$bb0:
...
const list_del: ref;
axiom (list_del == $sub.ref(0, 506));
procedure  list_del( entry: ref)
{
  var {:base "entry"} $p0: ref;
  var $p1: ref;
  var {:base "entry"} $p2: ref;
  var $p3: ref;
  var {:base "entry"} $p4: ref;
  var {:base "entry"} $p5: ref;
$bb0:
  ...
  $p4 := entry;
  assume {:sourceloc "./list.h", 99, 2} true;
  $M.0 := $store.ref($M.0, $p4, $i2p.i64.ref(1048832));
  assume {:sourceloc "./list.h", 100, 2} true;
  $p5 := $add.ref(entry, 8);
  assume {:sourceloc "./list.h", 100, 2} true;
  $M.0 := $store.ref($M.0, $p5, $i2p.i64.ref(2097664));
  assume {:sourceloc "./list.h", 101, 1} true;
  $exn := false;
  return;
}
const __list_del: ref;
axiom (__list_del == $sub.ref(0, 514));
procedure  __list_del( prev: ref,  next: ref)
{
  var {:base "next"} $p0: ref;
  var {:base "prev"} $p1: ref;
$bb0:
  ...
  $p0 := $add.ref(next, 8);
  assume {:sourceloc "./list.h", 86, 2} true;
  $M.0 := $store.ref($M.0, $p0, prev);
  assume {:sourceloc "./list.h", 87, 2} true;
  $p1 := prev;
  assume {:sourceloc "./list.h", 87, 2} true;
  $M.0 := $store.ref($M.0, $p1, next);
  assume {:sourceloc "./list.h", 88, 1} true;
  $exn := false;
  return;
}
const __list_add: ref;
axiom (__list_add == $sub.ref(0, 522));
procedure  __list_add( new: ref,  prev: ref,  next: ref)
{
  var {:base "next"} $p0: ref;
  var {:base "new"} $p1: ref;
  var {:base "new"} $p2: ref;
  var {:base "prev"} $p3: ref;
$bb0:
  call {:cexpr "new"} boogie_si_record_ref(new);
  call {:cexpr "prev"} boogie_si_record_ref(prev);
  call {:cexpr "next"} boogie_si_record_ref(next);
  ...
  $p2 := $add.ref(new, 8);
  assume {:sourceloc "./list.h", 47, 2} true;
  $M.0 := $store.ref($M.0, $p2, prev);
  assume {:sourceloc "./list.h", 48, 2} true;
  $p3 := prev;
  assume {:sourceloc "./list.h", 48, 2} true;
  $M.0 := $store.ref($M.0, $p3, new);
  assume {:sourceloc "./list.h", 49, 1} true;
  $exn := false;
  return;
}
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 530));
procedure  llvm.dbg.value({:scalar} $p0: ref, {:scalar} $i1: i64, {:scalar} $p2: ref, {:scalar} $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 538));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i8($M.0, __PRETTY_FUNCTION__.add_node, 118);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 1), 111);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 2), 105);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 3), 100);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 4), 32);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 5), 97);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 6), 100);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 7), 100);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 8), 95);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 9), 110);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 10), 111);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 11), 100);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 12), 101);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 13), 40);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 14), 105);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 15), 110);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 16), 116);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 17), 44);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 18), 32);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 19), 115);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 20), 116);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 21), 114);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 22), 117);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 23), 99);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 24), 116);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 25), 32);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 26), 108);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 27), 105);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 28), 115);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 29), 116);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 30), 95);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 31), 104);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 32), 101);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 33), 97);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 34), 100);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 35), 32);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 36), 42);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 37), 41);
  $M.0 := $store.i8($M.0, $add.ref(__PRETTY_FUNCTION__.add_node, 38), 0);
  $exn := false;
  return;
}
