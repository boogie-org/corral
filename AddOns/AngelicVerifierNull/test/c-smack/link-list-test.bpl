...
// via /usr/local/bin/smack --no-verify link-list-test.c -bpl link-list-test.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 445));
...
const .str1262: ref;
axiom (.str1262 == $sub.ref(0, 105));
const .str1263: ref;
axiom (.str1263 == $sub.ref(0, 168));
const .str1264: ref;
axiom (.str1264 == $sub.ref(0, 271));
const .str1266: ref;
axiom (.str1266 == $sub.ref(0, 275));
const .str11267: ref;
axiom (.str11267 == $sub.ref(0, 277));
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 285));
...
axiom (__VERIFIER_assert == $sub.ref(0, 309));
procedure {:inline 1} __VERIFIER_assert({:scalar} x: i32)
{
$bb0:
...
$bb2:
  ...
  call $i9 := printf.ref.i32(.str1266, $i8);
  assume {:sourceloc "link-list-test.c", 26, 5} true;
  $p10 := $p2;
  assume {:sourceloc "link-list-test.c", 26, 5} true;
...
const free_: ref;
axiom (free_ == $sub.ref(0, 381));
procedure  free_( $p0: ref)
{
  call $free($p0);
}
const find_first_and_delete: ref;
axiom (find_first_and_delete == $sub.ref(0, 389));
...
axiom (__list_del == $sub.ref(0, 421));
...
axiom (__list_add == $sub.ref(0, 429));
