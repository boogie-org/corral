...
// via /usr/local/bin/smack t6.c -bpl t6.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point bar
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 176));
...
axiom (__SMACK_decls == $sub.ref(0, 96));
...
axiom (__SMACK_top_decl == $sub.ref(0, 104));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 112));
...
axiom (devirtbounce == $sub.ref(0, 176));
