...
// via /usr/local/bin/smack --no-verify t26.c -bpl t26.bpl
...
$bb0:
  ...
  assume {:sourceloc "t26.c", 7, 8} true;
  $p0 := $bitcast.ref.ref(x);
  assume {:sourceloc "t26.c", 7, 3} true;
  call free_($p0);
  assume {:sourceloc "t26.c", 8, 3} true;
  call bar(x);
  assume {:sourceloc "t26.c", 9, 1} true;
  $exn := false;
  return;
}
