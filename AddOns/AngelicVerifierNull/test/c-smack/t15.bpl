...
// via /usr/local/bin/smack t15.c -bpl t15.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point main
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 156));
