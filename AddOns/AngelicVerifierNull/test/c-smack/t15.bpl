...
// via /usr/local/bin/smack --no-verify t15.c -bpl t15.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 383));
...
axiom (__SMACK_code == $sub.ref(0, 311));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 319));
...
axiom (__SMACK_top_decl == $sub.ref(0, 327));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 335));
...
$bb0:
  ...
  $p6 := $p5;
  assume {:sourceloc "t15.c", 14, 9} true;
  $i7 := $extractvalue($p4, 0);
  assume {:sourceloc "t15.c", 14, 9} true;
  $M.1 := $store.i32($M.1, $p6, $i7);
  assume {:sourceloc "t15.c", 14, 9} true;
  $p8 := $add.ref($p5, 8);
  assume {:sourceloc "t15.c", 14, 9} true;
  $p9 := $extractvalue($p4, 1);
  assume {:sourceloc "t15.c", 14, 9} true;
  $M.1 := $store.ref($M.1, $p8, $p9);
  assume {:sourceloc "t15.c", 14, 3} true;
  $p10 := $bitcast.ref.ref($p0);
  assume {:sourceloc "t15.c", 14, 3} true;
  $p11 := $bitcast.ref.ref($p1);
  assume {:sourceloc "t15.c", 14, 3} true;
  call $M.1 := $memcpy.i8($M.1, $M.1, $p10, $p11, 16, $zext.i32.i64(8), (0 == 1));
...
const bar: ref;
axiom (bar == $sub.ref(0, 351));
procedure  bar({:scalar} $i0: i32,  $p1: ref)
  returns ({:scalar} $r: ref);
const malloc: ref;
axiom (malloc == $sub.ref(0, 359));
...
axiom (llvm.memcpy.p0i8.p0i8.i64 == $sub.ref(0, 367));
procedure  llvm.memcpy.p0i8.p0i8.i64( $p0: ref,  $p1: ref, {:scalar} $i2: i64, {:scalar} $i3: i32, {:scalar} $i4: i1);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 375));
procedure  llvm.dbg.value({:scalar} $p0: ref, {:scalar} $i1: i64, {:scalar} $p2: ref, {:scalar} $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 383));
