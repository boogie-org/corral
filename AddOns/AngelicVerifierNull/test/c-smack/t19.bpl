...
// via /usr/local/bin/smack --no-verify t19.c -bpl t19.bpl
...
axiom (__SMACK_dummy == $sub.ref(0, 281));
...
axiom (__SMACK_code == $sub.ref(0, 289));
procedure  __SMACK_code.ref( $p0: ref);
const exit: ref;
axiom (exit == $sub.ref(0, 297));
...
axiom (__SMACK_decls == $sub.ref(0, 305));
...
axiom (__SMACK_top_decl == $sub.ref(0, 313));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 321));
...
const g_string_append_c_inline: ref;
axiom (g_string_append_c_inline == $sub.ref(0, 329));
procedure  g_string_append_c_inline( gstring: ref, {:scalar} c: i8)
  returns ( $r: ref)
{
  var {:scalar} $i0: i8;
  var {:base "gstring"} $p1: ref;
  var {:scalar} $i2: i32;
  var {:scalar} $i3: i32;
  var {:base "gstring"} $p4: ref;
  var {:scalar} $i5: i32;
  var {:scalar} $i6: i1;
  var {:base "gstring"} $p7: ref;
  var {:scalar} $i8: i32;
  var {:scalar} $i9: i32;
  var {:scalar} $i10: i64;
  var {:base "gstring"} $p11: ref;
  var $p12: ref;
  var {:base "$p12"} $p13: ref;
  var {:base "gstring"} $p14: ref;
  var {:scalar} $i15: i32;
  var {:scalar} $i16: i64;
  var {:base "gstring"} $p17: ref;
  var $p18: ref;
  var {:base "$p18"} $p19: ref;
  var {:scalar} $i20: i32;
  var {:scalar} $i21: i32;
$bb0:
  call {:cexpr "gstring"} boogie_si_record_ref(gstring);
  call {:cexpr "c"} boogie_si_record_i8(c);
  assume {:sourceloc "t19.c", 18, 7} true;
  call $i0 := demonic_char();
  call {:cexpr "c"} boogie_si_record_i8($i0);
  assume {:sourceloc "t19.c", 19, 7} true;
  $p1 := $add.ref(gstring, 8);
  assume {:sourceloc "t19.c", 19, 7} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "t19.c", 19, 7} true;
  $i3 := $add.i32($i2, 1);
  assume {:sourceloc "t19.c", 19, 26} true;
  $p4 := $add.ref(gstring, 12);
  assume {:sourceloc "t19.c", 19, 26} true;
  $i5 := $load.i32($M.0, $p4);
  assume {:sourceloc "t19.c", 19, 7} true;
  $i6 := $slt.i32($i3, $i5);
...
$bb1:
  assume ($i6 == 1);
  assume {:sourceloc "t19.c", 21, 20} true;
  $p7 := $add.ref(gstring, 8);
  assume {:sourceloc "t19.c", 21, 20} true;
  $i8 := $load.i32($M.0, $p7);
  assume {:sourceloc "t19.c", 21, 20} true;
  $i9 := $add.i32($i8, 1);
  ...
  assume {:sourceloc "t19.c", 21, 7} true;
  $i10 := $sext.i32.i64($i8);
  assume {:sourceloc "t19.c", 21, 7} true;
  $p11 := gstring;
  assume {:sourceloc "t19.c", 21, 7} true;
  ...
  assume {:sourceloc "t19.c", 21, 7} true;
  $p13 := $add.ref($p12, $mul.ref($i10, 1));
  assume {:sourceloc "t19.c", 21, 7} true;
  $M.0 := $store.i8($M.0, $p13, $i0);
  assume {:sourceloc "t19.c", 22, 20} true;
  $p14 := $add.ref(gstring, 8);
  assume {:sourceloc "t19.c", 22, 20} true;
  $i15 := $load.i32($M.0, $p14);
  assume {:sourceloc "t19.c", 22, 7} true;
  ...
  assume {:sourceloc "t19.c", 22, 7} true;
  $p19 := $add.ref($p18, $mul.ref($i16, 1));
  assume {:sourceloc "t19.c", 22, 7} true;
  $M.0 := $store.i8($M.0, $p19, 0);
  assume {:sourceloc "t19.c", 23, 5} true;
  goto $bb3;
$bb2:
  assume !(($i6 == 1));
  assume {:sourceloc "t19.c", 26, 37} true;
  $i20 := $sext.i8.i32($i0);
  assume {:sourceloc "t19.c", 26, 5} true;
  call $i21 := g_string_insert_c.ref.i32.i32(gstring, $sub.i32(0, 1), $i20);
  goto $bb3;
$bb3:
  assume {:sourceloc "t19.c", 27, 3} true;
  $r := gstring;
  $exn := false;
  return;
}
const demonic_char: ref;
axiom (demonic_char == $sub.ref(0, 337));
procedure  demonic_char()
  returns ({:scalar} $r: i8);
const g_string_insert_c: ref;
axiom (g_string_insert_c == $sub.ref(0, 345));
procedure  g_string_insert_c.ref.i32.i32({:scalar} p.0: ref,  p.1: i32,  p.2: i32)
