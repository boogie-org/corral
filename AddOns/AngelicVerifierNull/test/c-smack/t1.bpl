...
// via /usr/local/bin/smack --no-verify t1.c -bpl t1.bpl
...
axiom (A == $sub.ref(0, 353));
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 361));
...
axiom (__SMACK_code == $sub.ref(0, 369));
procedure  __SMACK_code.ref( $p0: ref);
const exit: ref;
axiom (exit == $sub.ref(0, 377));
...
axiom (__SMACK_decls == $sub.ref(0, 385));
...
axiom (__SMACK_top_decl == $sub.ref(0, 393));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 401));
...
{
$bb0:
  $M.1 := $store.ref($M.1, A, $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 8), $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 16), $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 24), $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 32), $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 40), $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 48), $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 56), $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 64), $0.ref);
  $M.1 := $store.ref($M.1, $add.ref(A, 72), $0.ref);
  $exn := false;
  return;
}
