...
{
  $CurrAddr := 1024;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(0, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(1, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(2, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(3, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(4, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(5, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(6, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(7, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(8, 8)))] := 0;
  $M.0[$add.ref(A, $zext.i32.ref($mul.i32(9, 8)))] := 0;
  return;
}
...
$bb0:
  ...
  $p2 := $sext.i32.i64($p1);
  assume {:sourceloc "t1.c", 10, 2} true;
  $p3 := $add.ref($add.ref(A, $zext.i32.ref($mul.i32(0, 80))), $mul.ref($p2, $zext.i32.ref(8)));
  assume {:sourceloc "t1.c", 10, 2} true;
  $p4 := $M.0[$p3];
