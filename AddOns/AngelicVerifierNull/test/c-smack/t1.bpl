...
// via /usr/local/bin/smack t1.c -bpl t1.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point func
...
axiom (A == $sub.ref(0, 140));
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 148));
...
axiom (__SMACK_code == $sub.ref(0, 156));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 164));
...
axiom (__SMACK_top_decl == $sub.ref(0, 172));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 180));
