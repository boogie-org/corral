...
// via /usr/local/bin/smack --no-verify t4.c -bpl t4.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 375));
...
axiom (__SMACK_dummy == $sub.ref(0, 295));
...
axiom (__SMACK_code == $sub.ref(0, 303));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 311));
...
axiom (__SMACK_top_decl == $sub.ref(0, 319));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 327));
...
const foo: ref;
axiom (foo == $sub.ref(0, 335));
procedure  foo({:scalar} b: i32,  a: ref)
  returns ( $r: ref)
{
  var {:scalar} $i0: i1;
  var $p2: ref;
...
$bb2:
  ...
  $p4 := $p3;
  assume {:sourceloc "t4.c", 15, 2} true;
  $M.0 := $store.i32($M.0, $p4, b);
  assume {:sourceloc "t4.c", 16, 2} true;
  $p5 := $add.ref($p3, 8);
  assume {:sourceloc "t4.c", 16, 2} true;
  $M.0 := $store.ref($M.0, $p5, a);
...
$bb0:
  call $initialize();
  call {:cexpr "m"} boogie_si_record_ref($0.ref);
