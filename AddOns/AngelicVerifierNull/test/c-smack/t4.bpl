...
$bb1:
  ...
  assume {:sourceloc "t4.c", 12, 3} true;
  assert $p4 != $0.i32;
  assume {:sourceloc "t4.c", 13, 3} true;
  $p5 := 0;
  goto $bb3;
$bb2:
  assume !(($p0 == 1));
  assume {:sourceloc "t4.c", 15, 18} true;
  call $p6 := $malloc(16);
  assume {:sourceloc "t4.c", 15, 18} true;
  $p7 := $p6;
  call {:cexpr "s"} boogie_si_record_ref($p7);
  assume {:sourceloc "t4.c", 16, 2} true;
  $p8 := $add.ref($add.ref($p7, $zext.i32.ref($mul.i32(0, 16))), $zext.i32.ref($mul.i32(0, 1)));
  assume {:sourceloc "t4.c", 16, 2} true;
  $M.1[$p8] := b;
  assume {:sourceloc "t4.c", 17, 2} true;
  $p9 := $add.ref($add.ref($p7, $zext.i32.ref($mul.i32(0, 16))), $zext.i32.ref($mul.i32(8, 1)));
  assume {:sourceloc "t4.c", 17, 2} true;
  $M.1[$p9] := a;
  assume {:sourceloc "t4.c", 18, 2} true;
  $p5 := $p7;
  goto $bb3;
$bb3:
  assume {:sourceloc "t4.c", 19, 1} true;
  $r := $p5;
  $exn := false;
  return;
}
procedure func(w: ref)
  modifies $Alloc, $CurrAddr, $exn, $exnv, $M.0, $M.1, $M.2;
{
  var $p0: i1;
  var $p1: i32;
...
$bb0:
  ...
  assume {:sourceloc "t4.c", 22, 2} true;
  $p0 := $ne.i64(w, 0);
  assume {:sourceloc "t4.c", 22, 2} true;
  $p1 := $zext.i1.i32($p0);
  assume {:sourceloc "t4.c", 22, 2} true;
  ...
  assume {:sourceloc "t4.c", 22, 2} true;
  assert $p3 != $0.i32;
  assume {:sourceloc "t4.c", 23, 19} true;
  $p4 := $M.2[w];
  assume {:sourceloc "t4.c", 23, 19} true;
  call $p5 := foo($p4, w);
  call {:cexpr "s"} boogie_si_record_ref($p5);
  assume {:sourceloc "t4.c", 24, 2} true;
  $p6 := $ne.i64($p5, 0);
  assume {:sourceloc "t4.c", 24, 2} true;
  $p7 := $zext.i1.i32($p6);
  assume {:sourceloc "t4.c", 24, 2} true;
  call __SMACK_dummy($p7);
  assume {:sourceloc "t4.c", 24, 2} true;
  $p8 := $ne.i64($p5, 0);
  assume {:sourceloc "t4.c", 24, 2} true;
  $p9 := $zext.i1.i32($p8);
  assume {:sourceloc "t4.c", 24, 2} true;
  assert $p9 != $0.i32;
  assume {:sourceloc "t4.c", 25, 2} true;
  $p10 := $add.ref($add.ref($p5, $zext.i32.ref($mul.i32(0, 16))), $zext.i32.ref($mul.i32(8, 1)));
  assume {:sourceloc "t4.c", 25, 2} true;
  $p11 := $M.1[$p10];
  assume {:sourceloc "t4.c", 25, 2} true;
  $p12 := $ne.i64($p11, 0);
  ...
  $p13 := $zext.i1.i32($p12);
  assume {:sourceloc "t4.c", 25, 2} true;
  call __SMACK_dummy($p13);
  assume {:sourceloc "t4.c", 25, 2} true;
  $p14 := $add.ref($add.ref($p5, $zext.i32.ref($mul.i32(0, 16))), $zext.i32.ref($mul.i32(8, 1)));
  assume {:sourceloc "t4.c", 25, 2} true;
  $p15 := $M.1[$p14];
  assume {:sourceloc "t4.c", 25, 2} true;
  $p16 := $ne.i64($p15, 0);
  ...
  assume {:sourceloc "t4.c", 25, 2} true;
  assert $p17 != $0.i32;
  assume {:sourceloc "t4.c", 26, 1} true;
  $exn := false;
  return;
}
procedure main()
...
$bb0:
  call $static_init();
  call $init_funcs();
  call {:cexpr "m"} boogie_si_record_ref(0);
  assume {:sourceloc "t4.c", 31, 6} true;
  call $p0 := $malloc(4);
  assume {:sourceloc "t4.c", 31, 6} true;
  $p1 := $p0;
  call {:cexpr "n"} boogie_si_record_ref($p1);
  assume {:sourceloc "t4.c", 32, 6} true;
  call $p2 := $malloc(4);
  assume {:sourceloc "t4.c", 32, 6} true;
  $p3 := $p2;
  ...
  $M.2[$p1] := 0;
  assume {:sourceloc "t4.c", 33, 10} true;
  $M.2[$p3] := 1;
  assume {:sourceloc "t4.c", 34, 2} true;
  call func(0);
  assume {:sourceloc "t4.c", 35, 2} true;
  call func($p1);
  assume {:sourceloc "t4.c", 36, 2} true;
  call func($p3);
  assume {:sourceloc "t4.c", 37, 2} true;
  $r := 0;
  $exn := false;
  return;
}
...
axiom (__SMACK_code == -24);
axiom (malloc == -32);
axiom (func == -40);
axiom (main == -48);
axiom (__SMACK_dummy == -56);
