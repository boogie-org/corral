...
// via /usr/local/bin/smack list_sample.c -bpl list_sample.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point main
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 278));
...
const .str11263: ref;
axiom (.str11263 == $sub.ref(0, 83));
const .str21264: ref;
axiom (.str21264 == $sub.ref(0, 85));
const .str31265: ref;
axiom (.str31265 == $sub.ref(0, 90));
const .str41266: ref;
axiom (.str41266 == $sub.ref(0, 92));
const .str51267: ref;
axiom (.str51267 == $sub.ref(0, 124));
const .str61268: ref;
axiom (.str61268 == $sub.ref(0, 155));
const .str71269: ref;
axiom (.str71269 == $sub.ref(0, 158));
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 166));
procedure  llvm.dbg.declare({:scalar} $p0: ref, {:scalar} $p1: ref, {:scalar} $p2: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 174));
...
axiom (__SMACK_code == $sub.ref(0, 182));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 190));
...
axiom (__SMACK_top_decl == $sub.ref(0, 198));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 206));
...
$bb3:
  ...
  call {:cexpr "result_node"} boogie_si_record_ref($0.ref);
  assume {:sourceloc "list_sample.c", 38, 2} true;
  $p27 := $p0;
  assume {:sourceloc "list_sample.c", 38, 2} true;
  $p28 := $load.ref($M.0, $p27);
  assume {:sourceloc "list_sample.c", 38, 2} true;
  $i29 := $eq.ref($p28, $0.ref);
  assume {:sourceloc "list_sample.c", 38, 2} true;
  $p30 := $0.ref;
...
$bb27:
  ...
  assume {:sourceloc "list_sample.c", 41, 3} true;
  $p69 := $add.ref($p30, 8);
  $p70 := $add.ref($add.ref($p30, 8), 8);
  assume {:sourceloc "list_sample.c", 41, 3} true;
  $p71 := $load.ref($M.0, $p70);
  assume {:sourceloc "list_sample.c", 41, 3} true;
  $M.0 := $store.ref($M.0, $p71, $p68);
  assume {:sourceloc "list_sample.c", 41, 3} true;
  $p72 := $bitcast.ref.ref($p30);
  assume {:sourceloc "list_sample.c", 41, 3} true;
  call free_($p72);
...
$bb52:
  ...
  assume {:sourceloc "list_sample.c", 48, 3} true;
  $p129 := $add.ref($p128, 8);
  $p130 := $add.ref($add.ref($p128, 8), 8);
  assume {:sourceloc "list_sample.c", 48, 3} true;
  $M.0 := $store.ref($M.0, $p130, $p125);
  assume {:sourceloc "list_sample.c", 48, 3} true;
  goto $bb54;
$bb53:
  assume {:sourceloc "list_sample.c", 48, 3} true;
...
$bb54:
  ...
  assume {:sourceloc "list_sample.c", 48, 3} true;
  $p134 := $add.ref($p95, 8);
  $p135 := $add.ref($add.ref($p95, 8), 8);
  assume {:sourceloc "list_sample.c", 48, 3} true;
  $p136 := $load.ref($M.0, $p135);
  assume {:sourceloc "list_sample.c", 48, 3} true;
  $M.0 := $store.ref($M.0, $p136, $p133);
  assume {:sourceloc "list_sample.c", 48, 3} true;
  $p137 := $bitcast.ref.ref($p95);
  assume {:sourceloc "list_sample.c", 48, 3} true;
  call free_($p137);
...
$bb66:
  ...
  assume {:sourceloc "list_sample.c", 52, 2} true;
  $p236 := $add.ref($p235, 8);
  $p237 := $add.ref($add.ref($p235, 8), 8);
  assume {:sourceloc "list_sample.c", 52, 2} true;
  $M.0 := $store.ref($M.0, $p237, $p233);
  assume {:sourceloc "list_sample.c", 54, 2} true;
  $p238 := $p0;
  assume {:sourceloc "list_sample.c", 54, 2} true;
  $p239 := $load.ref($M.0, $p238);
  assume {:sourceloc "list_sample.c", 54, 2} true;
  $i240 := $eq.ref($p239, $0.ref);
  assume {:sourceloc "list_sample.c", 54, 2} true;
...
$bb67:
  ...
  call {:cexpr "tail"} boogie_si_record_ref($0.ref);
  call {:cexpr "nmerges"} boogie_si_record_i32(0);
  assume {:sourceloc "list_sample.c", 52, 2} true;
  $i165, $p166, $p167 := 0, $0.ref, $p163;
  goto $bb68;
$bb68:
  assume {:sourceloc "list_sample.c", 52, 2} true;
...
$bb69:
  ...
  call {:cexpr "psize"} boogie_si_record_i32(0);
  call {:cexpr "i"} boogie_si_record_i32(0);
  assume {:sourceloc "list_sample.c", 52, 2} true;
  $i170, $i171, $p172 := 0, 0, $p167;
  goto $bb71;
$bb70:
  assume !(($i168 == 1));
  assume {:sourceloc "list_sample.c", 52, 2} true;
...
$bb92:
  ...
  assume {:sourceloc "list_sample.c", 52, 2} true;
  $p224 := $add.ref($p198, 8);
  $p225 := $add.ref($add.ref($p198, 8), 8);
  assume {:sourceloc "list_sample.c", 52, 2} true;
  $M.0 := $store.ref($M.0, $p225, $p223);
...
$bb97:
  ...
  assume {:sourceloc "list_sample.c", 56, 2} true;
  $i259 := $eq.ref($p258, $0.ref);
  assume {:sourceloc "list_sample.c", 56, 2} true;
  assume {:branchcond $i259} true;
  goto $bb104, $bb106;
$bb98:
  assume {:sourceloc "list_sample.c", 54, 2} true;
  $i245 := $ne.ref($p244, $0.ref);
  assume {:sourceloc "list_sample.c", 54, 2} true;
...
$bb113:
  ...
  assume {:sourceloc "list_sample.c", 56, 2} true;
  $p286 := $add.ref($p285, 8);
  $p287 := $add.ref($add.ref($p285, 8), 8);
  assume {:sourceloc "list_sample.c", 56, 2} true;
  $M.0 := $store.ref($M.0, $p287, $p282);
  assume {:sourceloc "list_sample.c", 56, 2} true;
  goto $bb115;
$bb114:
  assume {:sourceloc "list_sample.c", 56, 2} true;
...
$bb115:
  ...
  assume {:sourceloc "list_sample.c", 56, 2} true;
  $p291 := $add.ref($p262, 8);
  $p292 := $add.ref($add.ref($p262, 8), 8);
  assume {:sourceloc "list_sample.c", 56, 2} true;
  $p293 := $load.ref($M.0, $p292);
  assume {:sourceloc "list_sample.c", 56, 2} true;
  $M.0 := $store.ref($M.0, $p293, $p290);
  assume {:sourceloc "list_sample.c", 56, 2} true;
  $p294 := $bitcast.ref.ref($p262);
  assume {:sourceloc "list_sample.c", 56, 2} true;
  call free_($p294);
...
const printf: ref;
axiom (printf == $sub.ref(0, 222));
procedure  printf.ref.i32( $p0: ref,  p.1: i32)
  returns ({:scalar} $r: i32);
procedure  printf.ref( $p0: ref)
  returns ({:scalar} $r: i32);
const free_: ref;
axiom (free_ == $sub.ref(0, 230));
procedure  free_( $p0: ref)
{
  call $free($p0);
}
const calloc: ref;
axiom (calloc == $sub.ref(0, 238));
procedure  calloc({:scalar} $i0: i64, {:scalar} $i1: i64)
  returns ( $r: ref);
const list_put: ref;
axiom (list_put == $sub.ref(0, 246));
procedure  list_put( head: ref, {:scalar} input: i32)
  returns ( $r: ref)
{
  var $p0: ref;
  var $p1: ref;
...
const smpl_print: ref;
axiom (smpl_print == $sub.ref(0, 254));
procedure  smpl_print( a: ref)
{
  var $p0: ref;
  var {:scalar} $i1: i32;
  var {:scalar} $i2: i32;
...
const smpl_cmp: ref;
axiom (smpl_cmp == $sub.ref(0, 262));
procedure  smpl_cmp( a: ref,  b: ref)
  returns ({:scalar} $r: i32)
{
  var $p0: ref;
  var {:scalar} $i1: i32;
