...
procedure {:entrypoint} func(w: int);



implementation {:entrypoint} func(w: int)
{
  var {:scalar} $i0: int;
  var $p1: int;
  var $p2: int;
...
axiom __SMACK_static_init == NULL - 140;
