...
axiom .str1409 == NULL - 91;

const .str1410: int;

axiom .str1410 == NULL - 154;

const .str1411: int;

axiom .str1411 == NULL - 257;

const {:allocated} __SMACK_dummy: int;

axiom __SMACK_dummy == NULL - 265;

const {:allocated} __SMACK_code: int;

axiom __SMACK_code == NULL - 273;

procedure __SMACK_code.ref({:pointer} $p0: int);



procedure __SMACK_code.ref.i32({:pointer} $p0: int, {:scalar} p.1: int);



const {:allocated} __VERIFIER_assert: int;

axiom __VERIFIER_assert == NULL - 281;

procedure {:inline 1} __VERIFIER_assert({:scalar} x: int);
...
var {:scalar} {:AllocatorVar} $CurrAddr: int;

procedure {:AngelicUnknown} {:allocator} $alloc(n: int) returns (p: int);
...
axiom __SMACK_top_decl == NULL - 305;
...
axiom __SMACK_init_func_memory_model == NULL - 313;

const {:allocated} zero: int;

axiom zero == NULL - 321;

procedure zero() returns ({:scalar} $r: int);
  modifies $exn;



implementation zero() returns ($r: int)
{

  $bb0:
    assume {:sourceloc "t25.c", 11, 13} true;
    $r := NULL;
    $exn := false;
    return;
}
...
procedure foo({:pointer} b: int);
  modifies $M.0, $exn, $CurrAddr, $Alloc;



implementation foo(b: int)
{
  var $p0: int;
  var $p1: int;
  var {:base "$p1"} $p2: int;
  ...
  var {:scalar} $i8: int;
  var {:scalar} $i9: int;
  var {:scalar} inline$__VERIFIER_assert$0$x: int;

  $bb0:
    call {:cexpr "b"} boogie_si_record_ref(b);
    assume {:sourceloc "t25.c", 15, 32} true;
    call $p0 := malloc(8);
    assume {:sourceloc "t25.c", 15, 19} true;
    $p1 := $p0;
    call {:cexpr "a"} boogie_si_record_ref($p0);
    assume {:sourceloc "t25.c", 17, 3} true;
    $p2 := $p1;
    assume {:sourceloc "t25.c", 17, 3} true;
    assert !($p1 == NULL);
    $M.0 := $M.0[$p2 := $p0];
    assume {:sourceloc "t25.c", 19, 7} true;
    call $i3 := zero();
    assume {:sourceloc "t25.c", 19, 7} true;
  ...
  $bb3:
    assume {:sourceloc "t25.c", 22, 3} true;
    $p6 := $p5;
    assume {:sourceloc "t25.c", 22, 3} true;
    assert !($p5 == NULL);
    $p7 := $M.0[$p6];
    assume {:sourceloc "t25.c", 22, 3} true;
    $i8 := (if $p7 != NULL then 1 else NULL);
    assume {:sourceloc "t25.c", 22, 3} true;
    $i9 := $i8;
    assume {:sourceloc "t25.c", 22, 3} true;
    goto inline$__VERIFIER_assert$0$Entry;

  inline$__VERIFIER_assert$0$Entry:
    inline$__VERIFIER_assert$0$x := $i9;
    goto inline$__VERIFIER_assert$0$$bb0;

  inline$__VERIFIER_assert$0$$bb0:
    call {:cexpr "x"} boogie_si_record_i32(inline$__VERIFIER_assert$0$x);
    call {:cexpr "v"} boogie_si_record_i32(inline$__VERIFIER_assert$0$x);
    ...
    assert inline$__VERIFIER_assert$0$x != NULL;
    assume {:sourceloc "/usr/local/share/smack/lib/smack.c", 37, 1} true;
    $exn := false;
    goto inline$__VERIFIER_assert$0$Return;

  inline$__VERIFIER_assert$0$Return:
    goto $bb3$1;

  $bb3$1:
    assume {:sourceloc "t25.c", 23, 1} true;
    $exn := false;
    return;

  $bb1:
    assume {:partition} $i4 == 1;
    call {:cexpr "b"} boogie_si_record_ref($p0);
    assume {:sourceloc "t25.c", 20, 5} true;
    $p5 := $p0;
    goto $bb3;
}
...
axiom malloc == NULL - 337;

procedure {:AngelicUnknown} {:allocator} malloc({:scalar} $i0: int) returns ($r: int);
  modifies $CurrAddr, $Alloc;
...
axiom __SMACK_static_init == NULL - 353;
...
const __block_call_zero: bool;

const __block_call_foo: bool;

const __block_call_malloc: bool;
...
procedure {:entrypoint} CorralMain();
  modifies $exnv, $exn, $CurrAddr, $Alloc, $M.0;
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    ...
    goto L_BAF_0, L_BAF_1, L_BAF_2, L_BAF_3, L_BAF_4, L_BAF_5, L_BAF_6, L_BAF_7, L_BAF_8;
  ...
  L_BAF_5:
    ...
    call {:ConcretizeConstantName "b_foo"} b_foo := unknown_int();
    assume MustReach(true);
    call {:AvhEntryPoint} foo(b_foo);
    return;
