...
implementation foo()
{
  ...
  $bb0:
    assume {:sourceloc "t23.c", 6, 18} true;
    call $p0 := malloc(4);
    ...
    assume {:sourceloc "t23.c", 9, 7} true;
    $p4 := (if $i3 == 1 then NULL else $p1);
    call {:cexpr "x"} boogie_si_record_ref($p4);
    assume {:sourceloc "t23.c", 12, 7} true;
    $i5 := (if $u0 > NULL then 1 else NULL);
    assume {:sourceloc "t23.c", 12, 7} true;
  ...
  $bb2:
    ...
    call {:cexpr "z"} boogie_si_record_i32(NULL);
    goto $bb3;

  $bb3:
    assume {:sourceloc "t23.c", 18, 3} true;
    assert !($p4 == NULL);
    $M.0 := $M.0[$p4 := 2];
    assume {:sourceloc "t23.c", 19, 1} true;
    $exn := false;
    return;
  ...
  $bb1:
    ...
    assume {:sourceloc "t23.c", 13, 5} true;
    goto $bb3;
}
...
procedure {:entrypoint} CorralMain();
  modifies $M.1, $exnv, $exn, $CurrAddr, $Alloc, $M.0;
...
implementation CorralMain()
{
  ...
  CorralMainStart:
    assume true;
    call {:ConcretizeConstantName "$M.1"} $M.1 := unknown_int();
    call {:ConcretizeConstantName "$exnv"} $exnv := unknown_int();
    goto L_BAF_0, L_BAF_1, L_BAF_2, L_BAF_3, L_BAF_4, L_BAF_5, L_BAF_6, L_BAF_7;
