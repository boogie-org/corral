...
// via /usr/local/bin/smack --no-verify t18.c -bpl t18.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 385));
...
{
$bb0:
  assume {:sourceloc "t18.c", 9, 13} true;
  $r := 0;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "t18.c", 13, 12} true;
  call $p0 := bar.ref.ref(.str1266, .str11267);
  call {:cexpr "z"} boogie_si_record_ref($p0);
  assume {:sourceloc "t18.c", 14, 7} true;
  call $i1 := foo();
  call {:cexpr "c"} boogie_si_record_i32($i1);
  assume {:sourceloc "t18.c", 16, 7} true;
  call $i2 := zero();
  assume {:sourceloc "t18.c", 16, 7} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "t18.c", 16, 7} true;
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "t18.c", 17, 9} true;
  $p4 := $bitcast.ref.ref($p0);
  assume {:sourceloc "t18.c", 17, 5} true;
  $M.1 := $store.ref($M.1, x, $p4);
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "t18.c", 19, 3} true;
  $M.0 := $store.i32($M.0, $p0, $i1);
  assume {:sourceloc "t18.c", 21, 5} true;
  $p5 := $load.ref($M.1, x);
  assume {:sourceloc "t18.c", 21, 4} true;
  $p6 := $load.ref($M.0, $p5);
  assume {:sourceloc "t18.c", 21, 3} true;
  $M.0 := $store.i32($M.0, $p6, 1);
  assume {:sourceloc "t18.c", 23, 3} true;
  $r := 0;
  $exn := false;
  return;
}
...
procedure  bar.ref.ref( $p0: ref, {:scalar} p.1: ref)
  returns ( $r: ref);
const foo: ref;
axiom (foo == $sub.ref(0, 369));
procedure  foo()
  returns ({:scalar} $r: i32);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 377));
procedure  llvm.dbg.value({:scalar} $p0: ref, {:scalar} $i1: i64, {:scalar} $p2: ref, {:scalar} $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 385));
