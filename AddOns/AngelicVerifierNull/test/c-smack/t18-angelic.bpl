...
// via /usr/local/bin/smack --no-verify t18-angelic.c -bpl t18-angelic.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 377));
...
const x: ref;
axiom (x == $sub.ref(0, 281));
const .str1266: ref;
axiom (.str1266 == $sub.ref(0, 285));
const .str11267: ref;
axiom (.str11267 == $sub.ref(0, 289));
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 297));
...
axiom (__SMACK_code == $sub.ref(0, 305));
procedure  __SMACK_code.ref( $p0: ref);
const exit: ref;
axiom (exit == $sub.ref(0, 313));
...
axiom (__SMACK_decls == $sub.ref(0, 321));
...
axiom (__SMACK_top_decl == $sub.ref(0, 329));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 337));
...
const zero: ref;
axiom (zero == $sub.ref(0, 345));
procedure  zero()
  returns ({:scalar} $r: i32)
{
$bb0:
  assume {:sourceloc "t18-angelic.c", 9, 13} true;
  $r := 0;
  $exn := false;
  return;
}
const func: ref;
axiom (func == $sub.ref(0, 353));
procedure  func({:scalar} c: i32)
  returns ({:scalar} $r: i32)
{
  var $p0: ref;
  var {:scalar} $i1: i32;
...
$bb0:
  ...
  assume {:sourceloc "t18-angelic.c", 13, 12} true;
  call $p0 := bar.ref.ref(.str1266, .str11267);
  call {:cexpr "z"} boogie_si_record_ref($p0);
  assume {:sourceloc "t18-angelic.c", 16, 7} true;
  call $i1 := zero();
  assume {:sourceloc "t18-angelic.c", 16, 7} true;
  $i2 := $ne.i32($i1, 0);
  assume {:sourceloc "t18-angelic.c", 16, 7} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "t18-angelic.c", 17, 9} true;
  $p3 := $bitcast.ref.ref($p0);
  assume {:sourceloc "t18-angelic.c", 17, 5} true;
  $M.1 := $store.ref($M.1, x, $p3);
  call {:cexpr "x"} boogie_si_record_ref($p3);
  assume {:sourceloc "t18-angelic.c", 17, 5} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "t18-angelic.c", 16, 7} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "t18-angelic.c", 19, 3} true;
  $M.0 := $store.i32($M.0, $p0, c);
  assume {:sourceloc "t18-angelic.c", 21, 5} true;
  $p4 := $load.ref($M.1, x);
  assume {:sourceloc "t18-angelic.c", 21, 4} true;
  $p5 := $load.ref($M.0, $p4);
  assume {:sourceloc "t18-angelic.c", 21, 3} true;
  $M.0 := $store.i32($M.0, $p5, 1);
  assume {:sourceloc "t18-angelic.c", 23, 3} true;
  $r := 0;
  $exn := false;
  return;
}
const bar: ref;
axiom (bar == $sub.ref(0, 361));
procedure  bar.ref.ref( $p0: ref, {:scalar} p.1: ref)
  returns ( $r: ref);
const llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 369));
procedure  llvm.dbg.value({:scalar} $p0: ref, {:scalar} $i1: i64, {:scalar} $p2: ref, {:scalar} $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 377));
