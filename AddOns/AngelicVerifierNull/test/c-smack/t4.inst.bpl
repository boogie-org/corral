...
axiom __SMACK_top_decl == NULL - 92;
...
axiom __SMACK_init_func_memory_model == NULL - 100;
...
procedure foo({:scalar} b: int, a: int) returns ($r: int);



implementation foo(b: int, a: int) returns ($r: int)
{
  var {:scalar} $i0: int;
  var $p2: int;
  var $p3: int;
  ...
  $bb0:
    ...
    assume {:sourceloc "t4.c", 11, 6} true;
    $i0 := (if b == NULL then 1 else NULL);
    assume {:sourceloc "t4.c", 11, 6} true;
  ...
  $bb1:
    assume $i0 == 1;
    assume {:sourceloc "t4.c", 12, 3} true;
    $p1 := NULL;
    goto $bb3;

  $bb2:
    assume !($i0 == 1);
    assume {:sourceloc "t4.c", 14, 18} true;
    call $p2 := malloc(16);
    assume {:sourceloc "t4.c", 14, 18} true;
    $p3 := $p2;
    call {:cexpr "s"} boogie_si_record_ref($p3);
    assume {:sourceloc "t4.c", 15, 2} true;
    $p4 := $p3;
    assume {:sourceloc "t4.c", 15, 2} true;
    assert !aliasQ0($p4, NULL);
    $M.0 := $M.0[$p4 := b];
    assume {:sourceloc "t4.c", 16, 2} true;
    $p5 := $p3 + 8;
    assume {:sourceloc "t4.c", 16, 2} true;
    assert !aliasQ1($p5, NULL);
    $M.0 := $M.0[$p5 := a];
    assume {:sourceloc "t4.c", 17, 2} true;
    $p1 := $p3;
    goto $bb3;

  $bb3:
    assume {:sourceloc "t4.c", 18, 1} true;
    $r := $p1;
    $exn := false;
    return;
}
...
procedure func(w: int);



implementation func(w: int)
{
  var {:scalar} $i0: int;
  var $p1: int;
  var $p2: int;
  ...
  $bb0:
    call {:cexpr "w"} boogie_si_record_ref(w);
    assume {:sourceloc "t4.c", 21, 23} true;
    assert !aliasQ2(w, NULL);
    $i0 := $M.1[w];
    assume {:sourceloc "t4.c", 21, 19} true;
    call $p1 := foo($i0, w);
    call {:cexpr "s"} boogie_si_record_ref($p1);
    assume {:sourceloc "t4.c", 22, 3} true;
    $p2 := $p1;
    assume {:sourceloc "t4.c", 22, 3} true;
    assert !aliasQ3($p2, NULL);
    $M.0 := $M.0[$p2 := 1];
    assume {:sourceloc "t4.c", 23, 1} true;
    $exn := false;
    return;
}
...
implementation {:entrypoint} main() returns ($r: int)
{
  ...
  $bb0:
    call $initialize();
    call {:cexpr "m"} boogie_si_record_ref(NULL);
    assume {:sourceloc "t4.c", 28, 6} true;
    call $p0 := malloc(4);
    assume {:sourceloc "t4.c", 28, 6} true;
    $p1 := $p0;
    call {:cexpr "n"} boogie_si_record_ref($p1);
    assume {:sourceloc "t4.c", 29, 6} true;
    call $p2 := malloc(4);
    assume {:sourceloc "t4.c", 29, 6} true;
    $p3 := $p2;
    call {:cexpr "p"} boogie_si_record_ref($p3);
    assume {:sourceloc "t4.c", 30, 2} true;
    assert !aliasQ4($p1, NULL);
    $M.1 := $M.1[$p1 := NULL];
    assume {:sourceloc "t4.c", 30, 10} true;
    assert !aliasQ5($p3, NULL);
    $M.1 := $M.1[$p3 := 1];
    assume {:sourceloc "t4.c", 31, 2} true;
    call func(NULL);
    assume {:sourceloc "t4.c", 32, 2} true;
    call func($p1);
    assume {:sourceloc "t4.c", 33, 2} true;
    call func($p3);
    assume {:sourceloc "t4.c", 34, 2} true;
    $r := NULL;
    $exn := false;
    return;
}
...
axiom __SMACK_static_init == NULL - 148;
