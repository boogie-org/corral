...
// via /usr/local/bin/smack --no-verify t19-simple.c -bpl t19-simple.bpl
...
const zero: ref;
axiom (zero == $sub.ref(0, 329));
procedure  zero()
  returns ({:scalar} $r: i32)
{
$bb0:
  assume {:sourceloc "t19-simple.c", 14, 2} true;
  $r := 0;
  $exn := false;
  return;
}
const g_string_append_c_inline: ref;
axiom (g_string_append_c_inline == $sub.ref(0, 337));
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "t19-simple.c", 22, 20} true;
  $p3 := $bitcast.ref.ref(gstring);
  assume {:sourceloc "t19-simple.c", 22, 5} true;
  $p4 := gstring;
  assume {:sourceloc "t19-simple.c", 22, 5} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "t19-simple.c", 23, 3} true;
  $p5 := gstring;
  assume {:sourceloc "t19-simple.c", 23, 3} true;
  $p6 := $load.ref($M.0, $p5);
  assume {:sourceloc "t19-simple.c", 23, 3} true;
  $p7 := $p6;
  assume {:sourceloc "t19-simple.c", 23, 3} true;
  $M.0 := $store.i8($M.0, $p7, $i0);
  assume {:sourceloc "t19-simple.c", 24, 3} true;
  $p8 := gstring;
  assume {:sourceloc "t19-simple.c", 24, 3} true;
  $p9 := $load.ref($M.0, $p8);
  assume {:sourceloc "t19-simple.c", 24, 3} true;
  ...
  assume {:sourceloc "t19-simple.c", 25, 3} true;
  $r := gstring;
  $exn := false;
  return;
}
const demonic_char: ref;
axiom (demonic_char == $sub.ref(0, 345));
