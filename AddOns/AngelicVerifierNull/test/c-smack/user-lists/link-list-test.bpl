...
// via /usr/local/bin/smack link-list-test.c -bpl link-list-test.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point main
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 311));
...
const .str1262: ref;
axiom (.str1262 == $sub.ref(0, 81));
const .str11263: ref;
axiom (.str11263 == $sub.ref(0, 98));
const {:count 39} __PRETTY_FUNCTION__.add_node: ref;
axiom (__PRETTY_FUNCTION__.add_node == $sub.ref(0, 137));
const .str21264: ref;
axiom (.str21264 == $sub.ref(0, 141));
const .str31265: ref;
axiom (.str31265 == $sub.ref(0, 143));
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 151));
procedure  llvm.dbg.declare({:scalar} $p0: ref, {:scalar} $p1: ref, {:scalar} $p2: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 159));
...
axiom (__SMACK_code == $sub.ref(0, 167));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 175));
...
axiom (__SMACK_top_decl == $sub.ref(0, 183));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 191));
...
axiom (__assert_fail == $sub.ref(0, 215));
procedure  __assert_fail( $p0: ref,  $p1: ref, {:scalar} $i2: i32,  $p3: ref);
const display: ref;
axiom (display == $sub.ref(0, 223));
...
const free_: ref;
axiom (free_ == $sub.ref(0, 247));
procedure  free_( $p0: ref)
{
  call $free($p0);
}
const find_first_and_delete: ref;
axiom (find_first_and_delete == $sub.ref(0, 255));
...
axiom (__list_del == $sub.ref(0, 287));
...
axiom (__list_add == $sub.ref(0, 295));
