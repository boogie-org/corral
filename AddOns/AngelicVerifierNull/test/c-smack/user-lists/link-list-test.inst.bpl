...
axiom .str11263 == NULL - 98;

const {:count 39} __PRETTY_FUNCTION__.add_node: int;

axiom __PRETTY_FUNCTION__.add_node == NULL - 137;

const .str21264: int;

axiom .str21264 == NULL - 141;

const .str31265: int;

axiom .str31265 == NULL - 143;

const llvm.dbg.declare: int;

axiom llvm.dbg.declare == NULL - 151;
...
axiom __SMACK_top_decl == NULL - 183;
...
axiom __SMACK_init_func_memory_model == NULL - 191;
...
axiom add_node == NULL - 199;

procedure add_node({:scalar} arg: int, head: int);



implementation add_node(arg: int, head: int)
{
  var $p0: int;
  var $p1: int;
  var {:scalar} $i2: int;
  ...
  $bb0:
    call {:cexpr "arg"} boogie_si_record_i32(arg);
    call {:cexpr "head"} boogie_si_record_ref(head);
    assume {:sourceloc "link-list-test.c", 13, 40} true;
    call $p0 := malloc(24);
    assume {:sourceloc "link-list-test.c", 13, 26} true;
    $p1 := $p0;
    call {:cexpr "fooPtr"} boogie_si_record_ref($p1);
    assume {:sourceloc "link-list-test.c", 14, 5} true;
  ...
  $bb1:
    assume $i2 == 1;
    assume {:sourceloc "link-list-test.c", 16, 5} true;
    $p3 := $p1;
    assume {:sourceloc "link-list-test.c", 16, 5} true;
    assert !aliasQ0($p3, NULL);
    $M.0 := $M.0[$p3 := arg];
    assume {:sourceloc "link-list-test.c", 17, 5} true;
    $p4 := $p1 + 8;
    assume {:sourceloc "link-list-test.c", 17, 5} true;
    $p5 := $p1 + 8;
    $p6 := $p1 + 8;
    ...
    $p9 := $p1 + 8 + 8;
    assume {:sourceloc "link-list-test.c", 17, 5} true;
    assert !aliasQ2($p9, NULL);
    $M.0 := $M.0[$p9 := $p7];
    assume {:sourceloc "link-list-test.c", 18, 14} true;
    $p10 := $p1 + 8;
    assume {:sourceloc "link-list-test.c", 18, 5} true;
    call list_add($p10, head);
    assume {:sourceloc "link-list-test.c", 19, 1} true;
    $exn := false;
    return;
  ...
  $bb2:
    assume !($i2 == 1);
    assume {:sourceloc "link-list-test.c", 14, 5} true;
    call __assert_fail(.str1262, .str11263, 14, __PRETTY_FUNCTION__.add_node);
    assume {:sourceloc "link-list-test.c", 14, 5} true;
    assume false;
    return;
}
...
axiom display == NULL - 223;

procedure display(head: int);



implementation display(head: int)
{
  var $p0: int;
  var $p1: int;
  var $p2: int;
  ...
  $bb0:
    call {:cexpr "head"} boogie_si_record_ref(head);
    assume {:sourceloc "link-list-test.c", 26, 5} true;
    $p0 := head;
    assume {:sourceloc "link-list-test.c", 26, 5} true;
    assert !aliasQ3($p0, NULL);
    $p1 := $M.0[$p0];
    call {:cexpr "iter"} boogie_si_record_ref($p1);
    assume {:sourceloc "link-list-test.c", 26, 5} true;
    $p2 := $p1;
    goto $bb1;
  ...
  $bb1:
    assume {:sourceloc "link-list-test.c", 26, 5} true;
    $i3 := (if $p2 != head then 1 else NULL);
    assume {:sourceloc "link-list-test.c", 26, 5} true;
  ...
  $bb2:
    assume $i3 == 1;
    call {:cexpr "__mptr"} boogie_si_record_ref($p2);
    assume {:sourceloc "link-list-test.c", 27, 18} true;
    $p4 := $p2;
    assume {:sourceloc "link-list-test.c", 27, 18} true;
    $p5 := $p4 + (NULL - (NULL + 8)) * 1;
    assume {:sourceloc "link-list-test.c", 27, 18} true;
    $p6 := $p5;
    call {:cexpr "objPtr"} boogie_si_record_ref($p6);
    assume {:sourceloc "link-list-test.c", 28, 23} true;
    $p7 := $p6;
    assume {:sourceloc "link-list-test.c", 28, 23} true;
    assert !aliasQ4($p7, NULL);
    $i8 := $M.0[$p7];
    assume {:sourceloc "link-list-test.c", 28, 9} true;
    call $i9 := printf.ref.i32(.str21264, $i8);
    assume {:sourceloc "link-list-test.c", 26, 5} true;
    $p10 := $p2;
    assume {:sourceloc "link-list-test.c", 26, 5} true;
    assert !aliasQ5($p10, NULL);
    $p11 := $M.0[$p10];
    call {:cexpr "iter"} boogie_si_record_ref($p11);
    assume {:sourceloc "link-list-test.c", 26, 5} true;
    $p2 := $p11;
    goto $bb1;
  ...
  $bb3:
    assume !($i3 == 1);
    assume {:sourceloc "link-list-test.c", 30, 5} true;
    call $i12 := printf.ref(.str31265);
    assume {:sourceloc "link-list-test.c", 31, 1} true;
    $exn := false;
    return;
}
...
const delete_all: int;

axiom delete_all == NULL - 239;

procedure delete_all(head: int);



implementation delete_all(head: int)
{
  var $p0: int;
  var $p1: int;
  var {:scalar} $i2: int;
  ...
  $bb0:
    call {:cexpr "head"} boogie_si_record_ref(head);
    assume {:sourceloc "link-list-test.c", 36, 5} true;
    goto $bb1;

  $bb1:
    assume {:sourceloc "link-list-test.c", 39, 5} true;
    $p0 := head;
    assume {:sourceloc "link-list-test.c", 39, 5} true;
    assert !aliasQ6($p0, NULL);
    $p1 := $M.0[$p0];
    call {:cexpr "iter"} boogie_si_record_ref($p1);
    assume {:sourceloc "link-list-test.c", 39, 5} true;
    $i2 := (if $p1 != head then 1 else NULL);
    assume {:sourceloc "link-list-test.c", 39, 5} true;
    assume {:branchcond $i2} true;
    goto $bb2, $bb3;
  ...
  $bb2:
    assume $i2 == 1;
    call {:cexpr "__mptr"} boogie_si_record_ref($p1);
    assume {:sourceloc "link-list-test.c", 40, 18} true;
    $p3 := $p1;
    assume {:sourceloc "link-list-test.c", 40, 18} true;
    $p4 := $p3 + (NULL - (NULL + 8)) * 1;
    assume {:sourceloc "link-list-test.c", 40, 18} true;
    $p5 := $p4;
    call {:cexpr "objPtr"} boogie_si_record_ref($p5);
    assume {:sourceloc "link-list-test.c", 41, 18} true;
    $p6 := $p5 + 8;
    assume {:sourceloc "link-list-test.c", 41, 9} true;
    call list_del($p6);
    assume {:sourceloc "link-list-test.c", 42, 14} true;
    $p7 := $p5;
    assume {:sourceloc "link-list-test.c", 42, 9} true;
    call free_($p7);
    assume {:sourceloc "link-list-test.c", 43, 9} true;
    goto $bb1;

  $bb3:
    assume !($i2 == 1);
    assume {:sourceloc "link-list-test.c", 45, 1} true;
    $exn := false;
    return;
}
...
const find_first_and_delete: int;

axiom find_first_and_delete == NULL - 255;

procedure find_first_and_delete({:scalar} arg: int, head: int) returns ({:scalar} $r: int);



implementation find_first_and_delete(arg: int, head: int) returns ($r: int)
{
  var $p0: int;
  var $p1: int;
  var $p2: int;
  ...
  $bb0:
    call {:cexpr "arg"} boogie_si_record_i32(arg);
    call {:cexpr "head"} boogie_si_record_ref(head);
    assume {:sourceloc "link-list-test.c", 52, 5} true;
    $p0 := head;
    assume {:sourceloc "link-list-test.c", 52, 5} true;
    assert !aliasQ7($p0, NULL);
    $p1 := $M.0[$p0];
    call {:cexpr "iter"} boogie_si_record_ref($p1);
    assume {:sourceloc "link-list-test.c", 52, 5} true;
    $p2 := $p1;
  ...
  $bb2:
    assume $i3 == 1;
    call {:cexpr "__mptr"} boogie_si_record_ref($p2);
    assume {:sourceloc "link-list-test.c", 53, 18} true;
    $p4 := $p2;
    assume {:sourceloc "link-list-test.c", 53, 18} true;
    $p5 := $p4 + (NULL - (NULL + 8)) * 1;
    assume {:sourceloc "link-list-test.c", 53, 18} true;
    $p6 := $p5;
    call {:cexpr "objPtr"} boogie_si_record_ref($p6);
    assume {:sourceloc "link-list-test.c", 54, 12} true;
    $p7 := $p6;
    assume {:sourceloc "link-list-test.c", 54, 12} true;
    assert !aliasQ8($p7, NULL);
    $i8 := $M.0[$p7];
    assume {:sourceloc "link-list-test.c", 54, 12} true;
    $i9 := (if $i8 == arg then 1 else NULL);
    assume {:sourceloc "link-list-test.c", 54, 12} true;
  ...
  $bb3:
    assume !($i3 == 1);
    assume {:sourceloc "link-list-test.c", 61, 5} true;
    $i12 := NULL;
    goto $bb6;

  $bb4:
    assume $i9 == 1;
    assume {:sourceloc "link-list-test.c", 55, 22} true;
    $p10 := $p6 + 8;
    assume {:sourceloc "link-list-test.c", 55, 13} true;
    call list_del($p10);
    assume {:sourceloc "link-list-test.c", 56, 18} true;
    $p11 := $p6;
    assume {:sourceloc "link-list-test.c", 56, 13} true;
    call free_($p11);
    assume {:sourceloc "link-list-test.c", 57, 13} true;
    $i12 := 1;
    goto $bb6;
  ...
  $bb5:
    ...
    $p13 := $p2;
    assume {:sourceloc "link-list-test.c", 52, 5} true;
    assert !aliasQ9($p13, NULL);
    $p14 := $M.0[$p13];
    call {:cexpr "iter"} boogie_si_record_ref($p14);
    assume {:sourceloc "link-list-test.c", 52, 5} true;
    $p2 := $p14;
    goto $bb1;

  $bb6:
    assume {:sourceloc "link-list-test.c", 62, 1} true;
    $r := $i12;
    $exn := false;
    return;
}
...
implementation {:entrypoint} main() returns ($r: int)
{
  ...
  $bb0:
    ...
    call $p1 := $alloc(16 * 1);
    assume true;
    assume {:sourceloc "link-list-test.c", 66, 5} true;
    $p2 := $p0;
    assume {:sourceloc "link-list-test.c", 66, 5} true;
    assert !aliasQ10($p2, NULL);
    $M.0 := $M.0[$p2 := $p0];
    assume {:sourceloc "link-list-test.c", 66, 5} true;
    $p3 := $p0 + 8;
    assume {:sourceloc "link-list-test.c", 66, 5} true;
    assert !aliasQ11($p3, NULL);
    $M.0 := $M.0[$p3 := $p0];
    assume true;
    assume {:sourceloc "link-list-test.c", 67, 5} true;
    $p4 := $p1;
    assume {:sourceloc "link-list-test.c", 67, 5} true;
    assert !aliasQ12($p4, NULL);
    $M.1 := $M.1[$p4 := $p1];
    assume {:sourceloc "link-list-test.c", 67, 5} true;
    $p5 := $p1 + 8;
    assume {:sourceloc "link-list-test.c", 67, 5} true;
    assert !aliasQ13($p5, NULL);
    $M.2 := $M.2[$p5 := $p1];
    assume {:sourceloc "link-list-test.c", 69, 5} true;
    call add_node(10, $p0);
    assume {:sourceloc "link-list-test.c", 70, 5} true;
    call add_node(20, $p0);
    assume {:sourceloc "link-list-test.c", 71, 5} true;
    call add_node(25, $p0);
    assume {:sourceloc "link-list-test.c", 72, 5} true;
    call add_node(30, $p0);
    assume {:sourceloc "link-list-test.c", 74, 5} true;
    call display($p0);
    assume {:sourceloc "link-list-test.c", 75, 5} true;
    call $i6 := find_first_and_delete(20, $p0);
    assume {:sourceloc "link-list-test.c", 76, 5} true;
    call display($p0);
    assume {:sourceloc "link-list-test.c", 77, 5} true;
    call delete_all($p0);
    assume {:sourceloc "link-list-test.c", 78, 5} true;
    call display($p0);
    assume {:sourceloc "link-list-test.c", 79, 1} true;
    $r := NULL;
    $exn := false;
    return;
}
...
implementation list_add(new: int, head: int)
{
  ...
  $bb0:
    ...
    call {:cexpr "head"} boogie_si_record_ref(head);
    assume {:sourceloc "./list.h", 61, 24} true;
    $p0 := head;
    assume {:sourceloc "./list.h", 61, 24} true;
    assert !aliasQ14($p0, NULL);
    $p1 := $M.0[$p0];
    assume {:sourceloc "./list.h", 61, 2} true;
    call __list_add(new, head, $p1);
    assume {:sourceloc "./list.h", 62, 1} true;
    $exn := false;
    return;
}
...
implementation list_del(entry: int)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "./list.h", 98, 13} true;
    $p0 := entry + 8;
    assume {:sourceloc "./list.h", 98, 13} true;
    assert !aliasQ15($p0, NULL);
    $p1 := $M.0[$p0];
    assume {:sourceloc "./list.h", 98, 26} true;
    $p2 := entry;
    assume {:sourceloc "./list.h", 98, 26} true;
    assert !aliasQ16($p2, NULL);
    $p3 := $M.0[$p2];
    assume {:sourceloc "./list.h", 98, 2} true;
    call __list_del($p1, $p3);
    assume {:sourceloc "./list.h", 99, 2} true;
    $p4 := entry;
    assume {:sourceloc "./list.h", 99, 2} true;
    assert !aliasQ17($p4, NULL);
    $M.0 := $M.0[$p4 := 1048832];
    assume {:sourceloc "./list.h", 100, 2} true;
    $p5 := entry + 8;
    assume {:sourceloc "./list.h", 100, 2} true;
    assert !aliasQ18($p5, NULL);
    $M.0 := $M.0[$p5 := 2097664];
    assume {:sourceloc "./list.h", 101, 1} true;
    $exn := false;
    return;
}
...
implementation __list_del(prev: int, next: int)
{
  ...
  $bb0:
    ...
    assume {:sourceloc "./list.h", 86, 2} true;
    $p0 := next + 8;
    assume {:sourceloc "./list.h", 86, 2} true;
    assert !aliasQ19($p0, NULL);
    $M.0 := $M.0[$p0 := prev];
    assume {:sourceloc "./list.h", 87, 2} true;
    $p1 := prev;
    assume {:sourceloc "./list.h", 87, 2} true;
    assert !aliasQ20($p1, NULL);
    $M.0 := $M.0[$p1 := next];
    assume {:sourceloc "./list.h", 88, 1} true;
    $exn := false;
    return;
}
...
implementation __list_add(new: int, prev: int, next: int)
{
  ...
  $bb0:
    ...
    $p0 := next + 8;
    assume {:sourceloc "./list.h", 45, 2} true;
    assert !aliasQ21($p0, NULL);
    $M.0 := $M.0[$p0 := new];
    assume {:sourceloc "./list.h", 46, 2} true;
    $p1 := new;
    assume {:sourceloc "./list.h", 46, 2} true;
    assert !aliasQ22($p1, NULL);
    $M.0 := $M.0[$p1 := next];
    assume {:sourceloc "./list.h", 47, 2} true;
    $p2 := new + 8;
    assume {:sourceloc "./list.h", 47, 2} true;
    assert !aliasQ23($p2, NULL);
    $M.0 := $M.0[$p2 := prev];
    assume {:sourceloc "./list.h", 48, 2} true;
    $p3 := prev;
    assume {:sourceloc "./list.h", 48, 2} true;
    assert !aliasQ24($p3, NULL);
    $M.0 := $M.0[$p3 := new];
    assume {:sourceloc "./list.h", 49, 1} true;
    $exn := false;
    return;
}
...
axiom __SMACK_static_init == NULL - 311;
...
implementation __SMACK_static_init()
{
  ...
  $bb0:
    assert !aliasQ25(__PRETTY_FUNCTION__.add_node, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node := 118];
    assert !aliasQ26(__PRETTY_FUNCTION__.add_node + 1, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 1 := 111];
    assert !aliasQ27(__PRETTY_FUNCTION__.add_node + 2, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 2 := 105];
    assert !aliasQ28(__PRETTY_FUNCTION__.add_node + 3, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 3 := 100];
    assert !aliasQ29(__PRETTY_FUNCTION__.add_node + 4, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 4 := 32];
    assert !aliasQ30(__PRETTY_FUNCTION__.add_node + 5, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 5 := 97];
    assert !aliasQ31(__PRETTY_FUNCTION__.add_node + 6, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 6 := 100];
    assert !aliasQ32(__PRETTY_FUNCTION__.add_node + 7, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 7 := 100];
    assert !aliasQ33(__PRETTY_FUNCTION__.add_node + 8, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 8 := 95];
    assert !aliasQ34(__PRETTY_FUNCTION__.add_node + 9, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 9 := 110];
    assert !aliasQ35(__PRETTY_FUNCTION__.add_node + 10, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 10 := 111];
    assert !aliasQ36(__PRETTY_FUNCTION__.add_node + 11, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 11 := 100];
    assert !aliasQ37(__PRETTY_FUNCTION__.add_node + 12, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 12 := 101];
    assert !aliasQ38(__PRETTY_FUNCTION__.add_node + 13, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 13 := 40];
    assert !aliasQ39(__PRETTY_FUNCTION__.add_node + 14, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 14 := 105];
    assert !aliasQ40(__PRETTY_FUNCTION__.add_node + 15, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 15 := 110];
    assert !aliasQ41(__PRETTY_FUNCTION__.add_node + 16, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 16 := 116];
    assert !aliasQ42(__PRETTY_FUNCTION__.add_node + 17, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 17 := 44];
    assert !aliasQ43(__PRETTY_FUNCTION__.add_node + 18, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 18 := 32];
    assert !aliasQ44(__PRETTY_FUNCTION__.add_node + 19, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 19 := 115];
    assert !aliasQ45(__PRETTY_FUNCTION__.add_node + 20, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 20 := 116];
    assert !aliasQ46(__PRETTY_FUNCTION__.add_node + 21, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 21 := 114];
    assert !aliasQ47(__PRETTY_FUNCTION__.add_node + 22, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 22 := 117];
    assert !aliasQ48(__PRETTY_FUNCTION__.add_node + 23, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 23 := 99];
    assert !aliasQ49(__PRETTY_FUNCTION__.add_node + 24, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 24 := 116];
    assert !aliasQ50(__PRETTY_FUNCTION__.add_node + 25, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 25 := 32];
    assert !aliasQ51(__PRETTY_FUNCTION__.add_node + 26, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 26 := 108];
    assert !aliasQ52(__PRETTY_FUNCTION__.add_node + 27, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 27 := 105];
    assert !aliasQ53(__PRETTY_FUNCTION__.add_node + 28, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 28 := 115];
    assert !aliasQ54(__PRETTY_FUNCTION__.add_node + 29, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 29 := 116];
    assert !aliasQ55(__PRETTY_FUNCTION__.add_node + 30, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 30 := 95];
    assert !aliasQ56(__PRETTY_FUNCTION__.add_node + 31, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 31 := 104];
    assert !aliasQ57(__PRETTY_FUNCTION__.add_node + 32, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 32 := 101];
    assert !aliasQ58(__PRETTY_FUNCTION__.add_node + 33, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 33 := 97];
    assert !aliasQ59(__PRETTY_FUNCTION__.add_node + 34, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 34 := 100];
    assert !aliasQ60(__PRETTY_FUNCTION__.add_node + 35, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 35 := 32];
    assert !aliasQ61(__PRETTY_FUNCTION__.add_node + 36, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 36 := 42];
    assert !aliasQ62(__PRETTY_FUNCTION__.add_node + 37, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 37 := 41];
    assert !aliasQ63(__PRETTY_FUNCTION__.add_node + 38, NULL);
    $M.0 := $M.0[__PRETTY_FUNCTION__.add_node + 38 := NULL];
    $exn := false;
    return;
}
