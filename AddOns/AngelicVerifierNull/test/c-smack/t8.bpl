...
// via /usr/local/bin/smack t8.c -bpl t8.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point bar
...
const y: ref;
axiom (y == $sub.ref(0, 64));
const x: ref;
axiom (x == $sub.ref(0, 72));
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 80));
...
axiom (__SMACK_code == $sub.ref(0, 88));
procedure  __SMACK_code.ref( $p0: ref);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 96));
procedure {:inline 1} __VERIFIER_nondet_int()
  returns ({:scalar} $r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 104));
...
axiom (__SMACK_top_decl == $sub.ref(0, 112));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 120));
...
axiom (__SMACK_static_init == $sub.ref(0, 176));
...
axiom (devirtbounce == $sub.ref(0, 184));
