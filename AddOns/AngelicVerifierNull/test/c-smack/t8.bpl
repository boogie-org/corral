...
// via /usr/local/bin/smack --no-verify t8.c -bpl t8.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 405));
...
axiom (__VERIFIER_nondet_int == $sub.ref(0, 317));
procedure {:inline 1} __VERIFIER_nondet_int()
  returns ({:scalar} $r: i32);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 325));
...
axiom (__SMACK_top_decl == $sub.ref(0, 333));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 341));
