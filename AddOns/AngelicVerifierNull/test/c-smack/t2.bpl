...
// via /usr/local/bin/smack --no-verify t2.c -bpl t2.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 433));
...
const .str1262: ref;
axiom (.str1262 == $sub.ref(0, 91));
const .str1263: ref;
axiom (.str1263 == $sub.ref(0, 154));
const .str1264: ref;
axiom (.str1264 == $sub.ref(0, 257));
const {:count 10} A: ref;
axiom (A == $sub.ref(0, 337));
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 345));
...
axiom (__SMACK_code == $sub.ref(0, 353));
procedure  __SMACK_code.ref( $p0: ref);
procedure  __SMACK_code.ref.i32( $p0: ref,  p.1: i32);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 361));
...
axiom (__SMACK_decls == $sub.ref(0, 377));
...
axiom (__SMACK_top_decl == $sub.ref(0, 385));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 393));
...
const incr: ref;
axiom (incr == $sub.ref(0, 409));
procedure  incr( $p0: ref)
  returns ( $r: ref);
const malloc: ref;
axiom (malloc == $sub.ref(0, 417));
...
axiom (llvm.dbg.value == $sub.ref(0, 425));
procedure  llvm.dbg.value({:scalar} $p0: ref, {:scalar} $i1: i64, {:scalar} $p2: ref, {:scalar} $p3: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 433));
procedure  __SMACK_static_init()
{
$bb0:
  $M.2 := $store.ref($M.2, A, $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 8), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 16), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 24), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 32), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 40), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 48), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 56), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 64), $0.ref);
  $M.2 := $store.ref($M.2, $add.ref(A, 72), $0.ref);
  $exn := false;
  return;
}
