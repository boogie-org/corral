...
// via /usr/local/bin/smack t2.c -bpl t2.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point func
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 212));
...
axiom (A == $sub.ref(0, 124));
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 132));
...
axiom (__SMACK_code == $sub.ref(0, 140));
procedure  __SMACK_code.ref( $p0: ref);
procedure  __SMACK_code.ref.i32( $p0: ref,  p.1: i32);
const __VERIFIER_assert: ref;
axiom (__VERIFIER_assert == $sub.ref(0, 148));
...
axiom (__SMACK_decls == $sub.ref(0, 156));
...
axiom (__SMACK_top_decl == $sub.ref(0, 164));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 172));
...
const func: ref;
axiom (func == $sub.ref(0, 180));
procedure {:entrypoint} func( x: ref)
{
  var {:scalar} $i0: i1;
  var {:scalar} $i1: i32;
  var $p2: ref;
...
const incr: ref;
axiom (incr == $sub.ref(0, 188));
procedure  incr( $p0: ref)
  returns ( $r: ref);
const malloc: ref;
axiom (malloc == $sub.ref(0, 196));
