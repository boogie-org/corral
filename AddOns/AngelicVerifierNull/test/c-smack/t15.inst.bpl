...
axiom llvm.dbg.declare == NULL - 68;
...
axiom __SMACK_top_decl == NULL - 100;
...
axiom __SMACK_init_func_memory_model == NULL - 108;
...
implementation {:entrypoint} main() returns ($r: int)
{
  ...
  $bb0:
    ...
    call $p1 := $alloc(16 * 1);
    assume true;
    assume {:sourceloc "t15.c", 14, 22} true;
    call $p2 := malloc(4);
    assume {:sourceloc "t15.c", 14, 16} true;
    $p3 := $p2;
    assume {:sourceloc "t15.c", 14, 9} true;
    call $p4 := bar(NULL, $p3);
    assume {:sourceloc "t15.c", 14, 9} true;
    $p5 := $p1;
    assume {:sourceloc "t15.c", 14, 9} true;
    $p6 := $p5;
    assume {:sourceloc "t15.c", 14, 9} true;
    $i7 := $extractvalue($p4, NULL);
    assume {:sourceloc "t15.c", 14, 9} true;
    assert !aliasQ0($p6, NULL);
    $M.1 := $M.1[$p6 := $i7];
    assume {:sourceloc "t15.c", 14, 9} true;
    $p8 := $p5 + 8;
    assume {:sourceloc "t15.c", 14, 9} true;
    $p9 := $extractvalue($p4, 1);
    assume {:sourceloc "t15.c", 14, 9} true;
    assert !aliasQ1($p8, NULL);
    $M.1 := $M.1[$p8 := $p9];
    assume {:sourceloc "t15.c", 14, 3} true;
    $p10 := $p0;
    assume {:sourceloc "t15.c", 14, 3} true;
    $p11 := $p1;
    assume {:sourceloc "t15.c", 14, 3} true;
    call $M.1 := $memcpy.i8($M.1, $M.1, $p10, $p11, 16, 8, NULL == 1);
    assume {:sourceloc "t15.c", 15, 5} true;
    $p12 := $p0 + 8;
    assume {:sourceloc "t15.c", 15, 5} true;
    assert !aliasQ2($p12, NULL);
    $p13 := $M.1[$p12];
    assume {:sourceloc "t15.c", 15, 3} true;
    assert !aliasQ3($p13, NULL);
    $M.2 := $M.2[$p13 := 1];
    assume {:sourceloc "t15.c", 16, 1} true;
    $r := NULL;
    $exn := false;
    return;
}
...
procedure bar({:scalar} $i0: int, $p1: int) returns ({:scalar} $r: int);
...
axiom llvm.memcpy.p0i8.p0i8.i64 == NULL - 140;
