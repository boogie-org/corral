...
// via /usr/local/bin/smack t9.c -bpl t9.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point main
...
const bar: ref;
axiom (bar == $sub.ref(0, 76));
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 84));
...
axiom (__SMACK_code == $sub.ref(0, 92));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 100));
...
axiom (__SMACK_top_decl == $sub.ref(0, 108));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 116));
