...
// via /usr/local/bin/smack --no-verify t9.c -bpl t9.bpl
...
const bar: ref;
axiom (bar == $sub.ref(0, 303));
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 311));
...
axiom (__SMACK_code == $sub.ref(0, 319));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 327));
...
axiom (__SMACK_top_decl == $sub.ref(0, 335));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 343));
...
$bb0:
  ...
  $p0 := $load.ref($M.0, $add.ref(bar, 8));
  assume {:sourceloc "t9.c", 11, 3} true;
  $M.1 := $store.i32($M.1, $p0, 1);
...
$bb0:
  $M.2 := 0;
  $M.0 := $store.ref($M.0, $add.ref(bar, 8), $0.ref);
  $exn := false;
  return;
}
