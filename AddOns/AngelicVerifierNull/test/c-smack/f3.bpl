...
// via /usr/local/bin/smack --no-verify f3.c -bpl f3.bpl
...
procedure  foo()
{
  ...
  var {:scalar} $i3: i32;
$bb0:
  assume {:sourceloc "f3.c", 5, 13} true;
  call $p0 := fopen(.str1413, .str11414);
  call {:cexpr "x"} boogie_si_record_ref($p0);
  assume {:sourceloc "f3.c", 6, 13} true;
  call $p1 := fopen(.str21415, .str11414);
  call {:cexpr "y"} boogie_si_record_ref($p1);
  assume {:sourceloc "f3.c", 7, 3} true;
  call $i2 := fclose($p0);
  assume {:sourceloc "f3.c", 8, 3} true;
  call $i3 := fclose($p1);
  assume {:sourceloc "f3.c", 9, 1} true;
  $exn := false;
  return;
}
