...
// via /usr/local/bin/smack --no-verify t17.c -bpl t17.bpl
...
$bb0:
  call $initialize();
  assume {:sourceloc "t17.c", 9, 12} true;
  call $p0 := foo();
  call {:cexpr "x"} boogie_si_record_ref($p0);
  assume {:sourceloc "t17.c", 10, 12} true;
  call $p1 := bar();
  call {:cexpr "y"} boogie_si_record_ref($p1);
  assume {:sourceloc "t17.c", 12, 3} true;
  $M.0 := $store.i32($M.0, $p0, 0);
  assume {:sourceloc "t17.c", 13, 3} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "t17.c", 13, 3} true;
  $i3 := $ne.i32($i2, 0);
  assume {:sourceloc "t17.c", 13, 3} true;
  ...
  assume {:sourceloc "t17.c", 14, 1} true;
  $r := 0;
  $exn := false;
  return;
}
