...
// via /usr/local/bin/smack --no-verify t29.bc -bpl t29.bpl
...
const {:allocated} _Z3fooPi: ref;
axiom (_Z3fooPi == $sub.ref(0, 329));
procedure  _Z3fooPi({:pointer} x: ref)
{
  var {:scalar} $i0: i1;
  var $p1: ref;
  var {:scalar} $i2: i1;
...
$bb0:
  ...
  assume {:sourceloc "t29.cpp", 3, 3} true;
  $i0 := $eq.ref(x, $0.ref);
  assume {:sourceloc "t29.cpp", 3, 3} true;
...
$bb2:
  ...
  assume {:sourceloc "t29.cpp", 5, 3} true;
  $i2 := $eq.ref($0.ref, $0.ref);
  assume {:sourceloc "t29.cpp", 5, 3} true;
...
$bb4:
  assume {:sourceloc "t29.cpp", 5, 3} true;
  assume {:partition} ($0.ref == $0.ref);
  goto $bb5;
$bb5:
  assume {:sourceloc "t29.cpp", 6, 1} true;
  $exn := false;
  return;
$bb6:
  assume {:partition} !(($0.ref == $0.ref));
...
const {:allocated} _ZdlPv: ref;
axiom (_ZdlPv == $sub.ref(0, 337));
procedure  _ZdlPv({:pointer} $p0: ref);
