...
// via /usr/local/bin/smack --no-verify f2.c -bpl f2.bpl
...
axiom (__SMACK_dummy == $sub.ref(0, 287));
...
$bb1:
  ...
  assume {:sourceloc "f2.c", 7, 5} true;
  call $i2 := fclose($p0);
  assume {:sourceloc "f2.c", 7, 5} true;
  goto $bb3;
$bb2:
