...
// via /usr/local/bin/smack --no-verify t28.c -bpl t28.bpl
...
procedure  foo({:pointer} x: ref, {:pointer} y: ref)
{
  var $p0: ref;
  var $p1: ref;
$bb0:
  ...
  assume {:sourceloc "t28.c", 7, 8} true;
  $p0 := $bitcast.ref.ref(x);
  assume {:sourceloc "t28.c", 7, 3} true;
  call free_($p0);
  assume {:sourceloc "t28.c", 8, 8} true;
  $p1 := $bitcast.ref.ref(y);
  assume {:sourceloc "t28.c", 8, 3} true;
  call free_($p1);
  assume {:sourceloc "t28.c", 10, 1} true;
  $exn := false;
  return;
}
const {:allocated} free_: ref;
axiom (free_ == $sub.ref(0, 337));
procedure  free_({:pointer} $p0: ref)
{
  call $free($p0);
}
