...
// via /usr/local/bin/smack --no-verify t13.c -bpl t13.bpl
...
axiom (__VERIFIER_nondet_pointer == $sub.ref(0, 311));
...
axiom (__VERIFIER_nondet == $sub.ref(0, 319));
...
const foo: ref;
axiom (foo == $sub.ref(0, 367));
procedure  foo({:ref "$M.1"} $p0: ref);
