...
// via /usr/local/bin/smack t13.c -bpl t13.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point main
...
axiom (__VERIFIER_nondet_pointer == $sub.ref(0, 84));
...
axiom (__VERIFIER_nondet == $sub.ref(0, 92));
