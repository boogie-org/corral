...
// via /usr/local/bin/smack test_list.c -bpl test_list.bpl --no-verify --verifier-options=/doModSetAnalysis --entry-point main
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 408));
...
const .str1262: ref;
axiom (.str1262 == $sub.ref(0, 79));
const .str11263: ref;
axiom (.str11263 == $sub.ref(0, 85));
const .str21264: ref;
axiom (.str21264 == $sub.ref(0, 87));
const .str31265: ref;
axiom (.str31265 == $sub.ref(0, 130));
const .str41266: ref;
axiom (.str41266 == $sub.ref(0, 147));
const .str51267: ref;
axiom (.str51267 == $sub.ref(0, 196));
const .str61268: ref;
axiom (.str61268 == $sub.ref(0, 242));
const .str71269: ref;
axiom (.str71269 == $sub.ref(0, 272));
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 280));
procedure  llvm.dbg.declare({:scalar} $p0: ref, {:scalar} $p1: ref, {:scalar} $p2: ref);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 288));
...
axiom (__SMACK_code == $sub.ref(0, 296));
procedure  __SMACK_code.ref( $p0: ref);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 304));
...
axiom (__SMACK_top_decl == $sub.ref(0, 312));
procedure  __SMACK_top_decl.ref( $p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 320));
...
axiom (__list_del == $sub.ref(0, 384));
...
axiom (__list_add == $sub.ref(0, 392));
