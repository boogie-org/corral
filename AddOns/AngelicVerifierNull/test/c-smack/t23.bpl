...
// RUN: %avn "%t1.bpl" /nodup /traceSlicing /copt:recursionBound:5 /copt:k:1 /dontGeneralize /copt:tryCTrace /EE:ignoreAllAssumes+ /EE:onlySlicAssumes- /ignoreAllAssumes- | %grep > %t3
// RUN: %diff "%s.expect" %t3

// generated by SMACK version 1.5.2 for corral
// via /usr/local/bin/smack --no-verify t23.c -bpl t23.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 357));
...
axiom (__SMACK_dummy == $sub.ref(0, 285));
...
axiom (__SMACK_decls == $sub.ref(0, 309));
