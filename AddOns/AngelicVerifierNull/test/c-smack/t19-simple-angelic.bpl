...
// via /usr/local/bin/smack --no-verify t19-simple-angelic.c -bpl t19-simple-angelic.bpl
...
{
$bb0:
  assume {:sourceloc "t19-simple-angelic.c", 14, 2} true;
  $r := 0;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "t19-simple-angelic.c", 21, 7} true;
  call $i0 := zero();
  assume {:sourceloc "t19-simple-angelic.c", 21, 7} true;
  $i1 := $ne.i32($i0, 0);
  assume {:sourceloc "t19-simple-angelic.c", 21, 7} true;
...
$bb1:
  assume ($i1 == 1);
  assume {:sourceloc "t19-simple-angelic.c", 22, 20} true;
  $p2 := $bitcast.ref.ref(gstring);
  assume {:sourceloc "t19-simple-angelic.c", 22, 5} true;
  $p3 := gstring;
  assume {:sourceloc "t19-simple-angelic.c", 22, 5} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "t19-simple-angelic.c", 23, 3} true;
  $p4 := gstring;
  assume {:sourceloc "t19-simple-angelic.c", 23, 3} true;
  $p5 := $load.ref($M.0, $p4);
  assume {:sourceloc "t19-simple-angelic.c", 23, 3} true;
  $p6 := $p5;
  assume {:sourceloc "t19-simple-angelic.c", 23, 3} true;
  $M.0 := $store.i8($M.0, $p6, c);
  assume {:sourceloc "t19-simple-angelic.c", 24, 3} true;
  $p7 := gstring;
  assume {:sourceloc "t19-simple-angelic.c", 24, 3} true;
  $p8 := $load.ref($M.0, $p7);
  assume {:sourceloc "t19-simple-angelic.c", 24, 3} true;
  ...
  assume {:sourceloc "t19-simple-angelic.c", 25, 3} true;
  $r := gstring;
  $exn := false;
  return;
}
