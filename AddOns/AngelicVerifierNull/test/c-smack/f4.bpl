...
// via /usr/local/bin/smack --no-verify f4.c -bpl f4.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 371));
...
const .str1409: ref;
axiom (.str1409 == $sub.ref(0, 107));
const .str1410: ref;
axiom (.str1410 == $sub.ref(0, 170));
const .str1411: ref;
axiom (.str1411 == $sub.ref(0, 273));
const .str1413: ref;
axiom (.str1413 == $sub.ref(0, 277));
const .str11414: ref;
axiom (.str11414 == $sub.ref(0, 279));
const .str21415: ref;
axiom (.str21415 == $sub.ref(0, 283));
const {:allocated} __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 291));
...
axiom (__SMACK_decls == $sub.ref(0, 315));
...
procedure  foo()
{
  ...
  var {:scalar} $i5: i32;
$bb0:
  assume {:sourceloc "f4.c", 5, 13} true;
  call $p0 := fopen(.str1413, .str11414);
  call {:cexpr "x"} boogie_si_record_ref($p0);
  assume {:sourceloc "f4.c", 6, 13} true;
  call $p1 := fopen(.str21415, .str11414);
  call {:cexpr "y"} boogie_si_record_ref($p1);
  assume {:sourceloc "f4.c", 7, 7} true;
  $i2 := $ne.ref($p0, $0.ref);
  assume {:sourceloc "f4.c", 7, 7} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume {:partition} !(($p0 == $0.ref));
  assume {:sourceloc "f4.c", 8, 5} true;
  call $i3 := fclose($p0);
  assume {:sourceloc "f4.c", 8, 5} true;
  goto $bb3;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "f4.c", 9, 7} true;
  $i4 := $ne.ref($p1, $0.ref);
  assume {:sourceloc "f4.c", 9, 7} true;
  assume {:branchcond $i4} true;
  goto $bb4, $bb5;
$bb4:
  assume {:partition} !(($p1 == $0.ref));
  assume {:sourceloc "f4.c", 10, 5} true;
  call $i5 := fclose($p1);
  assume {:sourceloc "f4.c", 10, 5} true;
  goto $bb6;
$bb5:
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "f4.c", 11, 1} true;
  $exn := false;
  return;
}
const {:allocated} fopen: ref;
axiom (fopen == $sub.ref(0, 347));
procedure  fopen({:pointer} $p0: ref, {:pointer} $p1: ref)
  returns ( $r: ref);
const {:allocated} fclose: ref;
axiom (fclose == $sub.ref(0, 355));
procedure  fclose({:pointer} $p0: ref)
  returns ( $r: i32);
const {:allocated} llvm.dbg.value: ref;
axiom (llvm.dbg.value == $sub.ref(0, 363));
procedure  llvm.dbg.value({:scalar} $p0: ref, {:scalar} $i1: i64, {:scalar} $p2: ref, {:scalar} $p3: ref);
const {:allocated} __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 371));
