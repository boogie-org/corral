...
procedure {:nohoudini} {:origName "main1"} {:osmodel} main1() returns (Tmp_133: int);
...
implementation {:origName "main1"} {:osmodel} main1() returns (Tmp_133: int)
{
