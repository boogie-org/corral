...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(12)
label_1:
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(11)
label_3:
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(36)
label_1:
assume (forall m:int:: {Res_KERNEL_SOURCE[m]} INT_LEQ(old(alloc), m) ==> Res_KERNEL_SOURCE[m] == old(Res_KERNEL_SOURCE)[m]);
assume (forall m:int:: {Res_PROBED[m]} INT_LEQ(old(alloc), m) ==> Res_PROBED[m] == old(Res_PROBED)[m]);
assume (forall m:int :: {Mem_T.INT4[m]} INT_LEQ(old(alloc), m) ==> Mem_T.INT4[m] == old(Mem_T.INT4)[m]);
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(28)
label_3:
Mem_T.INT4 := Mem_T.INT4[x := 0];
goto label_4;


// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(31)
label_4:
goto label_5;
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(33)
label_8:
goto label_9;
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(35)
label_12:
goto label_13;
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(22)
label_1:
assume (forall m:int:: {Res_KERNEL_SOURCE[m]} INT_LEQ(old(alloc), m) ==> Res_KERNEL_SOURCE[m] == old(Res_KERNEL_SOURCE)[m]);
assume (forall m:int:: {Res_PROBED[m]} INT_LEQ(old(alloc), m) ==> Res_PROBED[m] == old(Res_PROBED)[m]);
assume (forall m:int :: {Mem_T.INT4[m]} INT_LEQ(old(alloc), m) ==> Mem_T.INT4[m] == old(Mem_T.INT4)[m]);
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(21)
label_3:
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(17)
label_1:
assume (forall m:int:: {Res_KERNEL_SOURCE[m]} INT_LEQ(old(alloc), m) ==> Res_KERNEL_SOURCE[m] == old(Res_KERNEL_SOURCE)[m]);
assume (forall m:int:: {Res_PROBED[m]} INT_LEQ(old(alloc), m) ==> Res_PROBED[m] == old(Res_PROBED)[m]);
assume (forall m:int :: {Mem_T.INT4[m]} INT_LEQ(old(alloc), m) ==> Mem_T.INT4[m] == old(Mem_T.INT4)[m]);
...
// c$$users\akashl\documents\work\stormchecker\examples\sanity_checks\storm_check.c(16)
label_3:
